...
# Purpose:     فحص سجل الأدوات — قياسٌ حيٌّ لعدد الأدوات المسجَّلة
# Owner:       tools/
# Created:     2026-08-15
...
# =============================================================================
"""
أداة فحص سجل الأدوات (Tools Registry Check).

الهدف: قياسُ حالةِ الإقليمِ من مصدرِ الحقيقةِ الحيِّ لحظةَ النداء، لا اقتباسُ
       ثابتٍ مكتوبٍ في الكود. ما يُقاس: عددُ صفوفِ جدولِ `tools`.
