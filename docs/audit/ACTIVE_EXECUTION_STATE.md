...
| 26 | AMD-003 — القرارُ المؤسِّس: المرجعيّةُ الملكيّةُ العليا ورفعُ RECON-005 |
| 27 | STAGE 1C — الجذرُ البشريّ: تنسيبُ تاجٍ لا تراه الدولة |
| 28 | STAGE 1D — نموذجُ السلطة: سحبُ الصلاحيةِ يمنع فعلًا |
| 29 | STAGE 1E — عقدُ التنفيذِ السياديّ: الأثرُ يُعلَن قبل وقوعِه |
| 30 | STAGE 1F — فصلُ موضعِ القرارِ عن موضعِ الإنفاذ: يُنفَّذ بإذنٍ لا بسلطة |
| 31 | STAGE 1G — جدارُ الاختصاصِ القضائيّ: حدودُ السلطةِ القضائيّةِ قبلَ التجاوز |
| 32 | STAGE 1H — الذرّيّةُ ومنعُ تكرارِ الأثر: عمليّةٌ واحدةٌ تُنتِجُ أثرًا واحدًا |
| 33 | STAGE 1I — التعويضُ عن الأثرِ المُطبَّق: معاملةٌ إمّا تتمُّ كاملةً أو لا تترك أثرًا |
| 34 | STAGE 1J — الإغلاقُ عند الفشل: لا ادّعاءَ نجاحٍ والمعاملةُ ناقصة |
| 35 | STAGE 1K — صادرُ الآثارِ الخارجيّةِ الدائم: الأثرُ يُثبَّتُ قبلَ محاولتِه ولا يُشهَدُ له إلّا بتأكيد |
| 36 | STAGE 1M — حدُّ الإنفاذِ السياديُّ والحرسُ الساكن: لا وصولَ إلى الأثرِ بتجاوزِ الحُرَّاسِ القائمين |
| 37 | STAGE 1N — وصلُ الإنفاذ: الحدُّ صارَ مسارَ التنفيذِ الفعليَّ، والمسارُ الذي كان يتجاوزُه أُغلِق |
...
| 1B المصالحةُ الدستوريّة | **مُنجَزة.** RECON-004 و005 و009 = 0؛ و15 فجوةً معلومةً موثَّقة |
| 1C الجذرُ البشريّ | **القدرةُ مُثبَتة، والتنصيبُ لم يقع.** مراسمُ إثباتِ الحيازةِ تعمل؛ والتاجُ `unprovisioned` بانتظارِ فعلٍ بشريّ |
| 1D نموذجُ السلطة | **جزئيّ.** السحبُ يمنع فعلًا ومقيسٌ من البوابة؛ والمنحُ استعادةٌ لا توسيع حتى 1E/1F |
| 1E عقدُ التنفيذ | **جزئيّ.** الأثرُ يُعلَن ويُقاس ويُمنَع ما خرج عنه، مقيسًا بحالةِ دولةٍ حقيقيّة؛ والمسارُ القديمُ بلا عقدٍ باقٍ ومعدودٌ ومُعلَن |
| 1F فصلُ القرارِ عن الإنفاذ | **جزئيّ.** موضعُ إنفاذٍ بلا محرّكٍ ولا مفتاحِ توقيعٍ يُنفِّذ إذنًا موقَّعًا صادرًا عن `execute` نفسِها، مقيسًا بحالةِ دولةٍ حقيقيّة؛ ولم يُفرَض المسارُ على أحدٍ بعدُ، والمفتاحُ عابرٌ مع العمليّة |
| 1G · 1H · 1I · 1J · 1K · 1M · 1N | **لم تُبدأ. NOT PROVEN.** |
...
أُدخلت جملةُ **«الملك لا سلطة له على الخزانة»** في نصِّ مرسومٍ ملكيٍّ قائم، <!-- ROYAL-LANG-EXEMPT: سجلٌّ تاريخيٌّ للثغرة المُثبَتة بالتجربة، لا تقريرٌ للمعنى -->
...
## 26. AMD-003 — القرارُ المؤسِّس: المرجعيّةُ الملكيّةُ العليا (2026-08-18)

**السند:** قرارُ المؤسِّس المُلزِم (خمسةَ عشرَ بندًا). ونُفِّذ مرسومًا دستوريًّا
لا وثيقةً شارحة، لأن البندَ السادسَ نصَّ صريحًا: التعارضُ **يُصلَح في النصِّ
الدستوريِّ نفسِه**، والبندُ الحاديَ عشرَ نصَّ: التعديلُ **يُسجَّل قرارًا دستوريًّا
مؤسِّسًا** لا اختيارًا للوكيل.

### 26.1 ما أُنشئ وما عُدِّل

| الأصل | الفعل | المضمون |
|---|---|---|
| `core/constitution/amendments/AMD-003-royal-reference-and-supremacy.md` | أُنشئ | المرسوم: سندُ الإصدار، المقصدُ المُثبَّت (7)، جدولُ البصماتِ قبل/بعد، حسمُ RECON-005، مراجعةُ RECON-004، عناصرُ A005 الخمسة |
| `core/constitution/articles/011-interpretation-hierarchy.md` | أُنشئ | المادةُ الحاديةَ عشرة: تسلسلُ التفسيرِ الإلزاميّ، قاعدةُ منعِ التآكل، آليةُ حلِّ التعارضِ (6 خطوات)، الصياغاتُ المحرَّمة |
| `core/constitution/articles/010-royal-sovereignty.md` | عُدِّل | §8 الخزينة (50% ملكًا للملك + جدولُ الطبقاتِ الخمس)، §9 المجلسُ الاستشاريُّ وحقُّ الاستفتاءِ والاطّلاعِ الشامل، §10 المنحُ والسحبُ والتفويضُ وإعادةُ الهيكلة، §11 حقُّ الإبطالِ وعشرةُ أنماطِ الفعل |
| `core/constitution/articles/005-amendment-process.md` | عُدِّل | §0 مقدّمةٌ حاكمة: التعديلُ اختصاصٌ ملكيٌّ حصرًا، وشروطُ المادةِ صارت **مسارَ المقترحِ التابع** للملك |
| `core/constitution/ARTICLE_SEALS.json` | أُعيد ختمُه | 12 نصًّا (PRE + A001..A011) — بسندِ المرسومِ وحده |
| `core/constitutional_engine/rules.py` | عُدِّل | خمسُ قواعدَ تشغيليّة: `R-010-8` `R-010-9` `R-010-10` `R-011-1` `R-011-2` |
| `docs/governance/ROYAL_SUPREMACY.md` · `docs/MASTER_PLAN.md` | أُنشئا | فصلُ السيادةِ الملكيّةِ وخطّةُ المرجع (البندُ الثالثَ عشر) |

### 26.2 رفعُ RECON-005 — من النصِّ لا من الشرح

كان التعارضُ: المادةُ الخامسةُ تشترط 90 يومًا و75% لتعديلِ الدستور، والعاشرةُ
تجعل التعديلَ اختصاصًا ملكيًّا حصريًّا. **الحسمُ بقرارِ المؤسِّس:** نسبةُ 75%
آليةٌ داخليةٌ للمجلسِ في مسارِ المقترحِ فقط، والمرسومُ الملكيُّ يُعدِّل مباشرةً
غيرَ مقيَّدٍ بمدّةٍ ولا بأغلبيّةٍ ولا بدراسة. ولم يخترعِ الوكيلُ تفسيرًا سياسيًّا:
النصُّ المُثبَّتُ هو نصُّ القرار.

| البصمة | قبل | بعد |
|---|---|---|
| A005 | `253c213f…a16b422` | `cd4e42af496cd1c1d7f6581d431eb7eb0064422e1ecdd056b132deeba85e36a9` |
| A010 | `38a5b036…5fc565` | `097ee875de375be68363e22aee226eb5d813855b586a8471b64c1e99616eb0fc` |
| A011 | — | `e7d1f630847b2fcb1418ecfb589a727f18f4011f776847ef5deeb49074acfaa0` |

**التحصينُ الآليّ:** `_conflict_resolved()` يقرأ رُكنَي الحسمِ من نصِّ A005 نفسِه؛
فإن حُذفا عاد `RECON-005` فورًا. والاختبارُ القديمُ الذي كان يُثبِّت **بقاءَ**
التعارضِ صُحِّح ليُثبِّت **زوالَه** — لأن الوثيقةَ القديمةَ هي التي تُصحَّح عند
تناقضِها مع القرارِ المؤسِّس.

### 26.3 RECON-004 — المدّةُ لم تُخفَّض ولم تُلغَ

`A005_REVIEW_DAYS == 90` باقيةً كما هي، وغرضُها مُثبَتٌ نصًّا: منعُ التعديلِ
المتعجِّل في مسارِ المقترح. والمرسومُ الملكيُّ **لا تسري عليه**. واختبارٌ صريحٌ
يمنعُ تخفيضَها لاحقًا بلا مرسوم.

### 26.4 حارسُ الصياغةِ الملكيّة (البندُ الثانيَ عشرَ — القاعدةُ الذهبيّة)

`RECON-009` يفحص `core/` `docs/` `royal/` `tools/` `tests/` `federal/` بسبعِ
صيغٍ محرَّمة (F-01…F-07) بعد تجريدِ التشكيل، مع استثناءٍ صريحٍ في السطرِ نفسِه
`ROYAL-LANG-EXEMPT` للسجلاتِ التاريخيّة. وأصلحَ الوكيلُ مخالفةً في **ملفِّ
اختباراتِه هو**، لا في ملفِّ غيره.

### 26.5 القدرةُ لا الملفّ

القاعدةُ 12 تمنع اعتبارَ الملفِّ دليلًا على القدرة. فالمادةُ الحاديةَ عشرةَ لم
تُترَك نصًّا معلَّقًا: `unguarded_articles()` كان يُرجِع `("A011",)` — وهو عطلٌ
حقيقيٌّ كشفَته الحزمةُ الجذريّة — فرُبطت بقاعدتين تُقيَّمان عند كلِّ فعل، وبنودُ
العاشرةِ المستحدثةُ (الخزينة · الاطّلاع · الإبطال) بثلاثٍ. وقياسُها من مسارِ
التقييمِ نفسِه: 12 فعلًا ممنوعًا يُرَدُّ بسببٍ مُعلَن، والفعلُ المحايدُ يمرّ،
والمرسومُ الملكيُّ يمضي حيثُ يُرَدُّ غيرُه.

### 26.6 السقوطُ الصامتُ الذي أدخلَه الوكيلُ ثمّ أزاله

رفعَ تدقيقُ الحقيقةِ العددَ من 97 إلى 98: `SILENT_FALLBACK` في حارسِ الصياغةِ
الجديد — ملفٌّ يتعذّرُ قراءتُه كان يُتجاوَزُ بصمت، أي **حارسٌ مُعطَّلٌ بلا علمِ
أحد**. أُصلحَ السببُ (يُرفَع الآن كمخالفةِ `RECON-009` ميكانيكيّة) لا الرقم،
وعادت السقّاطةُ إلى 97.

### 26.7 الإفصاحُ الصريح — ما ليس مُثبَتًا

- **المرسومُ غيرُ موقَّعٍ Ed25519.** التاجُ غيرُ مُنصَّبٍ (المرحلة 1C)، ولم
  يُلفَّق توقيع. عنصرُ التوقيعِ في المرسومِ مكتوبٌ `SIGNATURE_REQUIRED — لم
  يُستوفَ`، والفحصُ يُبلِّغُ عن AMD-003 **غيرَ موقَّعٍ** ولا يُعدُّ بصمةَ SHA-256
  توقيعًا (أُغلقت هذه السلبيّةُ الكاذبةُ في هذا العمل).
- **`COMPLETION = NOT YET COMPUTABLE`** — لا رقمَ مُختَرَعًا.
- **الاعتمادات الثلاثة (GitHub · Supabase) ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**

### 26.8 القياسُ بعد العمل

| البوابة | النتيجة |
|---|---|
| الحزمةُ الجذريّة | **915 ناجحًا · 0 فاشلًا** (كانت 873) |
| `tests/governance/` | 144 ناجحًا (كانت 123) |
| `tests/constitutional/` + `tests/sovereignty/` | 418 ناجحًا |
| تغطيةُ النواةِ الدستوريّة (فروع) | 95.45% ≥ 90 — و`rules.py` 100% |
| تغطيةُ نواةِ السيادة (فروع) | 94.20% ≥ 90 |
| تدقيقُ الحقيقة `--ratchet` | 97 مخالفة · 0 إقليمٍ مُثبَت · مستقرّ |
| المصالحةُ الدستوريّة | **15** بعد 16 · RECON-004 = 0 · RECON-005 = 0 · RECON-009 = 0 |
| سجلُّ بصماتِ التاريخ | مطابقٌ (`--verify-history`) |
| هويةُ المستودع · أختامُ README · `ruff` | نجحت |

---

## 27. STAGE 1C — الجذرُ البشريّ: تنسيبُ تاجٍ لا تراه الدولة (2026-08-18)

### 27.1 ما وجدَه الفحصُ قبل أيِّ كتابة

القاعدةُ الأولى تمنع الكتابةَ قبل الفحص، والقاعدتان 5 و6 تمنعان محرّكًا ثالثًا
وطبقةً موازية. فالفحصُ سبقَ العمل، وقاس ثلاثةَ أمورٍ لم تكن معلومةً بالانطباع:

1. `core/crown/` نطاقٌ ناضجٌ قائمٌ (7607 أسطر): الهويّات وسجلُّ المفاتيح والمرساة
   والخلافةُ والاستردادُ ومكتبةُ التهديدات. **فلم يُنشَأ شيءٌ منها من جديد.**
2. `core/sovereignty/crown.py` و`core/crown/` **بلا حافّةِ استيرادٍ واحدةٍ بينهما**
   في الاتّجاهين — قياسٌ لا انطباع. والتقسيمُ مقصودٌ ومُوثَّق: تلك تعرف «المفتاحَ
   النشطَ الآن»، وهذه تعرف دورةَ الحياة.
3. مفرداتُ المصدرِ (`KeyProvenance`: مراسم · بيئةُ توقيع · شهود · تحقّقٌ خارج
   القناة) **موجودةٌ سلفًا**. فأُعيد استعمالُها ولم تُخترَع مفرداتٌ منافسة.

### 27.2 الفجوةُ الحقيقيّة — وعدٌ إجرائيٌّ لا ضمانٌ تقنيّ

كان المسارُ الوحيدُ للتنصيب `provision_crown`: **الدولةُ تُولِّد مفتاحَ الملكِ
الخاصّ** ثمّ تكتبه على القرص، والوثيقةُ تقول للملك «انقله إلى حرزك واحذفه من
الجهاز». وهذا يناقض الضمانَ المُعلَنَ في رأسِ الملفِّ نفسِه: «لا يُحفَظ في أيِّ
نظامٍ تشغيليٍّ للدولة بأيِّ حال». فالدولةُ **رأتْه** لحظةَ توليدِه، والنقلُ بعد
ذلك إجراءٌ بشريٌّ لا ضمانٌ بنيويّ. وهذا مسُّ جوهرٍ بالمرحلة 1C: جذرُ دولةٍ تُولِّده
الدولةُ ليس جذرًا بشريًّا.

### 27.3 ما أُنجز — مراسمُ تحدٍّ وإثباتِ حيازة

| الأصل | الفعل | المضمون |
|---|---|---|
| `core/sovereignty/crown.py` | وُسِّع | `EnrollmentChallenge` · `issue_enrollment_challenge` · `load_enrollment_challenge` · `enroll_crown` · `ROOT_EXTERNAL_HUMAN` / `ROOT_STATE_GENERATED` · `CrownImpersonationError` |
| `core/sovereignty/cli.py` | وُسِّع | `crown-challenge` و`crown-enroll`، وأصلُ الجذرِ في `crown-status`، وبوابةٌ في `sovereignty-check` |
| `tests/sovereignty/test_crown_human_root.py` | أُنشئ | 24 اختبارًا تقيس القدرةَ من مسارِ التنفيذ |
| `royal/crown/README.md` · `core/sovereignty/README.md` | صُحِّحا | المراسمُ الثلاثُ بدل الأمرِ القديم |

**التسلسل:** الدولةُ تُصدِر تحدّيًا عامًّا لمرّةٍ واحدة → الملكُ يوقّعه **على
جهازِه خارجَ الدولة** → الدولةُ تُنسِّب **المفتاحَ العامَّ وحدَه** بعد تحقُّقٍ
تعمويٍّ من أن مُقدِّمَه يملك خاصَّه. فما لم ترَه الدولةُ قطُّ لا يمكن أن تُسرِّبه.

**الحمايات المقيسة:** فصلُ مجالٍ صريح (`AMOS-FEDERATION/CROWN-ENROLLMENT/v1`)
فتوقيعٌ صُنع لغرضٍ آخرَ لا يصلح تنسيبًا · تحدٍّ يُوسَم مُستهلَكًا فلا إعادةَ تشغيل
· أجلٌ منتهٍ · رفضُ المنتحِل **بخطأٍ أمنيٍّ مرفوعٍ** لا بقيمةٍ كاذبة · لا كتابةَ
سجلٍّ عند أيِّ إخفاق · لا تنسيبَ فوق تاجٍ قائم.

**الواجهةُ نفسُها تمنع التسريب:** اختبارٌ يفحص توقيعَ `enroll_crown` ويُسقِط أيَّ
معاملٍ يقبل مفتاحًا خاصًّا أو مسارَ ملفٍّ له. فالمنعُ بنيويٌّ لا تحذيرٌ في وثيقة.

### 27.4 الأصلُ القديمُ لم يُهدَم بل صار يقول الحقيقة

القاعدتان 3 و11 تمنعان هدمَ الأصول. فبقيَ `provision_crown` عاملًا لاختباراتِ
النواةِ وأدواتِ الإثباتِ الصناعيّ، لكنّه صار يَسِم سجلَّه `STATE_GENERATED`،
وحدُّه مكتوبٌ في مِحرابِ دالّتِه لا في هامش. و`sovereignty-check` **تسقط** إن كان
جذرُ الدولةِ الحقيقيِّ بهذا الأصل. والسجلُّ القديمُ بلا حقلِ أصلٍ لا يُمنَح صفةَ
الجذرِ البشريِّ بالسكوت: الغيابُ يُقرَأ نفيًا لا إثباتًا.

### 27.5 السقوطُ الصامتُ الثاني الذي أدخلَه الوكيلُ ثمّ أزاله

رفعَ التدقيقُ العددَ 97 → 98 ثانيةً: فحصُ المستودعِ في حزمتي الجديدةِ كان يبتلع
خطأَ الترميز، أي **ملفٌّ غيرُ مفحوصٍ يمرُّ كأنّه سليم**. أُصلح بقراءةِ بايتاتٍ لا
نصًّا فزال الاستثناءُ أصلًا، وعادت السقّاطةُ إلى 97. وهذه ثانيةُ مرّةٍ في يومَين
يُدخل فيها الوكيلُ مخالفةً ويُصلحها — تُسجَّل ولا تُخفى.

### 27.6 القياس

| البوابة | النتيجة |
|---|---|
| الحزمةُ الجذريّة | **938 ناجحًا · 1 متخطًّى · 0 فاشلًا** (كانت 915) |
| حزمةُ الجذرِ البشريّ | 23 ناجحًا · 1 متخطًّى بصدق |
| تغطيةُ نواةِ السيادة (فروع) | 92.33% ≥ 90 |
| `verify_crown_root_of_trust.py` · `crown-check` | نجحتا |
| تدقيقُ الحقيقة `--ratchet` | 97 · مستقرّ |
| هويةُ المستودع · `ruff` | نجحتا |

### 27.7 ما ليس مُثبَتًا — بصراحة

- **التاجُ ما زال `unprovisioned`.** المراسمُ **قدرةٌ مُثبَتةُ العمل**، لكنّ
  التنصيبَ نفسَه **فعلٌ بشريٌّ لا يملكه الوكيل**: لا يجوز أن يولّد الوكيلُ مفتاحَ
  الملك، وإلّا نقضَ المرحلةَ التي ينفّذها. والاختبارُ الذي يفحص السجلَّ الحقيقيَّ
  **يتخطّى نفسَه بإعلانٍ صريح** ولا يدّعي نجاحًا.
- **لا يُعلَن إقليمُ التاجِ PROVEN.** التدقيقُ ما زال 0 أقاليمَ مُثبَتة.
- **أمنُ جهازِ الملك** خارجَ مقدرةِ البرمجيّة، ومُصرَّحٌ به في حدود `core/crown/`.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **الاعتماداتُ الثلاثةُ ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**

---

## 28. STAGE 1D — نموذجُ السلطةِ السياديّ: سحبُ الصلاحيةِ يمنع فعلًا (2026-08-18)

### 28.1 ما وجدَه الفحصُ قبل أيِّ كتابة

نموذجُ السلطةِ **قائمٌ وناضجٌ** من E2.1 ولم يُبنَ منه شيءٌ من جديد: طبقاتٌ خمسٌ
مرتّبةٌ عدديًّا (`AuthorityLayer`) والتاجُ صفرُها ولا طبقةَ فوقه بحراسةٍ مباشرة ·
`classify()` تُثبت الملكيّةَ تعميًّا لا بحقلٍ يكتبه الطالب · بوابةٌ سياديّةٌ
بمسارَين · بوابةٌ لكلِّ طبقةٍ تابعةٍ لا ترقّي فيها · سجلُّ أحداثٍ أمنيّة.

فلم يكن سؤالُ 1D «أين النموذج؟» بل «**أيُّ بندٍ من المادة العاشرة بلا أثرٍ
تشغيليٍّ فيه؟**».

### 28.2 الفجوةُ الحقيقيّة — اختصاصٌ حصريٌّ بفعلٍ لا تملكه الدولة

المادةُ العاشرة · 10 · 1 تُعطي الملكَ أن «يمنح الصلاحيات ويوسّعها ويقلّصها
ويسحبها ويفوّضها … ويوقِفَ مؤسّسةً أو يستبدلَها». والقياسُ على الشجرةِ الحقيقيّة:

`grant_authority` و`revoke_authority` **سلسلتا حروفٍ في مجموعةٍ مجمّدةٍ** في
`prerogatives.py` وحدها. ولم يقرأ **أيُّ مكوّنٍ** في `core/sovereignty/` حالةَ
منحٍ قائمةً قطُّ — لا البوابةُ ولا التصنيفُ ولا الفحصُ الذاتيّ. فكان النظامُ يعرف
**من يحقُّ له أن يسحب**، ولا يعرف **ماذا يترتّب على أنّه سحب**.

أي أنّ الملكَ كان مُختصًّا حصريًّا بفعلٍ **لا تملكه الدولةُ أصلًا**: يوقّع مرسومَ
سحبٍ فيُقبَل توقيعُه ويُستهلَك مرسومُه، ثمّ يمضي المسحوبُ منه يعمل كأن شيئًا لم
يكن. وهذه هي القاعدةُ العليا 12 بحرفِها: وجودُ الاسمِ ليس وجودَ القدرة.

### 28.3 المُنجَز — سجلٌّ سياديٌّ يُقرَأ من مسارِ التنفيذ

| الأصل | الفعل | المضمون |
|---|---|---|
| `core/sovereignty/authority_grants.py` | أُنشئ (351 سطرًا) | `AuthorityGrant` · `AuthorityGrantRegistry` · `GrantState` · `withdraw` · `grant` · `RoyalAuthorityErosionError` |
| `core/sovereignty/gateway.py` | وُسِّع | خطوةٌ **سابقةٌ للتقييم** في المسار التابع + `AuthorityWithdrawn` + `active_withdrawals` في الفحصِ الذاتيّ |
| `core/sovereignty/security_events.py` | وُسِّع | `WITHDRAWN_AUTHORITY_USE` بدرجة HIGH |
| `tests/sovereignty/test_authority_grants.py` | أُنشئ | 30 اختبارًا تقيس القدرةَ من البوابةِ لا من الدالّة |

**الأثرُ المقيس:** يوقّع الملكُ مرسومَ سحب → يُسجَّل على القرص → **البوابةُ نفسُها
التي تنفّذ بها الدولةُ ترفض الفعلَ رفضًا مُغلَقًا ولا تستدعي المُنفِّذ**، وتُسجّل
حدثًا أمنيًّا وأثرًا في سجلِّ التنفيذ. وخطُّ الأساسِ مقيسٌ أيضًا: الفعلُ **يقع**
قبل السحب، فالمنعُ لاحقًا سببُه السحبُ لا شيءٌ آخر.

**الدقّةُ مقيسةٌ في أربعِ جهات:** سحبُ فعلٍ لا يعمُّ أفعالَ الفاعلِ الأخرى · ولا
يعمُّ فاعلًا آخرَ في الطبقةِ نفسِها · والسحبُ الجامعُ `*` يوقف المؤسّسةَ كلَّها
(§10 · 1) · والأخصُّ يسبق الجامعَ فيُمكن إيقافُ مؤسّسةٍ مع استثناءِ فعلٍ واحد.

### 28.4 لا محرّكَ تخويلٍ ثانٍ ولا طبقةَ موازية

القاعدتان 5 و6 حُرِستا بقياسٍ لا بنيّة: الطبقاتُ هي `AuthorityLayer` نفسُها،
والفاعلونَ `Branch` نفسُه، والإثباتُ `classify()` نفسُه — وهذه الوحدةُ **لا
تتحقّق من ملكيّةِ أحدٍ بنفسها** بل تطلب `AuthorityClassification` ثابتَ الأصالةِ
وترفض غيرَه. و`state_government_delegations` في R8 تفويضٌ **أفقيٌّ** بين تابعٍ
وتابعٍ داخل الطبقةِ الفدراليّة، وهذا سجلٌّ **رأسيٌّ** من التاجِ إلى تابع: لا
تكرارَ ولا تنافُسَ على مصدرِ حقيقة.

ومصدرُ الحقيقةِ **على القرصِ بكتابةٍ ذرّيّة** (القاعدة 17)، وكلُّ استعلامٍ يقرأ
الملفَّ: فلا تبقى صلاحيّةٌ مسحوبةٌ نافذةً في ذاكرةِ عمليّةٍ قديمة. واختبارٌ يُثبِت
أن سجلًّا ثانيًا على المسارِ نفسِه يرى السحبَ بلا حالةٍ مشتركةٍ بينهما.

### 28.5 القاعدةُ الذهبيّة محروسةٌ بنيويًّا لا بوثيقة

- **لا سحبَ من التاج:** محاولةُ التصرّفِ في صلاحيةِ `Branch.ROYAL` ترفع
  `RoyalAuthorityErosionError`. و**منحُه** مرفوضٌ كذلك: مَن يمنح يستطيع أن يمنع،
  فصلاحيةُ الملكِ أصلٌ لا منحة.
- **المسارُ السياديُّ لا يقرأ سجلَّ السحبِ أصلًا** — واختبارٌ يقيس ذلك بمرسومٍ
  حقيقيٍّ لفعلٍ مسحوبٍ من غيرِه، فينفُذ. ولو مُنع الملكُ بسحبٍ لصار السجلُّ سلطةً
  فوق التاج.
- **§10 · 2 مقيسٌ بغيابِ الحقل:** لا `irrevocable` ولا `permanent` ولا
  `protected` في `AuthorityGrant`، واختبارٌ يفحص الحقولَ نفسَها ويُسقِط أيَّ حقلٍ
  من هذا النوع. فتحصينُ منحةٍ ضدَّ الملكِ **غيرُ قابلٍ للتعبيرِ عنه** لا ممنوعًا
  بتحذير.
- `CONSTITUTIONAL_CARVE_OUTS` **فارغةٌ قياسًا لا تقديرًا**: لا مادّةَ مختومةً
  تُنشئ مجالًا لا يدخله الملك، واختبارٌ يحرس فراغَها فإضافةُ استثناءٍ فعلٌ
  دستوريٌّ مقصودٌ لا سهوُ مبرمج.
- ولا «تحصينَ بالتكرار»: ثلاثُ منحٍ ثمّ سحبٌ واحدٌ ⇒ الفعلُ ممنوع.

### 28.6 القياس

| البوابة | النتيجة |
|---|---|
| الحزمةُ الجذريّة | **968 ناجحًا · 1 متخطًّى · 0 فاشلًا** (كانت 938) |
| حزمةُ المنحِ والسحب | 30 ناجحًا · 0 متخطًّى |
| تغطيةُ نواةِ السيادة (فروع) | 92.97% ≥ 90 |
| تدقيقُ الحقيقة `--ratchet` | 97 · مستقرّ · لا مخالفةَ جديدة |
| المصالحةُ الدستوريّة | 15 · RECON-004/005/009 = 0 |
| `prove_supreme_authority` · `verify_crown_root_of_trust` | نجحا |
| الهويّة · الأختام · `ruff` | نجحت |

### 28.7 ما ليس مُثبَتًا — بصراحة

- **المنحُ لا يفتح قدرةً جديدةً لم تكن للفاعل.** الدولةُ لم تُقِم بعدُ سجلَّ
  أفعالٍ محكومًا بالقدرات، فالمنحُ اليومَ **استعادةٌ لا توسيع**. وهذا مكتوبٌ في
  رأسِ الوحدةِ نفسِها ولا يُدَّعى غيرُه — وهو عملُ 1E و1F.
- **الغيابُ يُقرَأ عدمَ سحبٍ لا عدمَ منح.** أي أنّ النموذجَ اليومَ **مانعٌ
  بالاستثناء** لا مانعٌ بالأصل. القراءةُ العكسيّةُ تُوقِف الدولةَ كلَّها عند أوّلِ
  تشغيل، وهي تعطيلٌ لا حراسة. والانتقالُ إلى «لا فعلَ بلا اختصاصٍ صريح» يلزمه
  عقدُ التنفيذِ السياديّ (1E) وفصلُ PDP/PEP (1F).
- **البنودُ الأخرى من القرارِ المؤسِّس** (المجلسُ الاستشاريُّ · حقُّ الاستفتاءِ ·
  حصّةُ الخزينة) محروسةٌ **منعًا** بقواعدَ من R-010-8 إلى R-011-2، ولمّا يصر لها
  أثرٌ **موجبٌ** تشغيليّ. تُسجَّل فجوةً معلومةً لا تُطوى.
- **لا يُعلَن إقليمٌ PROVEN.** التدقيقُ ما زال 0 أقاليمَ مُثبَتة.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **الاعتماداتُ الثلاثةُ ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**

---

## 29. STAGE 1E — عقدُ التنفيذِ السياديّ: الأثرُ يُعلَن قبل وقوعِه (2026-08-18)

### 29.1 ما وجدَه الفحصُ قبل أيِّ كتابة

مسارُ التنفيذِ **قائمٌ وواحدٌ ولم يُبنَ منه شيءٌ جديد**: `SovereignGateway.execute`
هي المسارُ الوحيد، و`gateways.py` تفوّض إليها، والنواةُ التنفيذيّةُ الفدراليّةُ
تصل إليها عبر `ConstitutionalAuthorizer.guard` في `executive_core/sovereignty_bridge.py`
— وقد أُثبت في R1 أنّ `POST /v1/execute` صار يمرُّ من النواةِ لا من حوله.

فلم يكن سؤالُ 1E «أين المُنفِّذ؟» بل «**ما الذي يربط ما وقع بما أُذِن به؟**».

### 29.2 الفجوةُ الحقيقيّة — إذنٌ لفعلٍ ومُنفِّذٌ بلا حدّ

`execute(request, executor: Callable[[], T])` تستقبل **دالّةً صفريّةَ المعاملات
مُبهَمةً تمامًا**. فالبوابةُ تُقيّم `request` — «اخصم من `treasury/account-A`» —
وتحكم `ALLOW`، ثمّ تستدعي `executor()`. و`executor` بعدها **حرٌّ حرّيّةً كاملة**:
له أن يمسّ حسابًا آخر، أو يحذف موردًا، أو ينادي طرفًا خارجيًّا. والقياسُ على
الشجرةِ كلِّها: لا `ExecutionContract` ولا `effect` ولا `post_condition` في ملفٍّ
واحد. أي أنّ **لا فرعَ في الكودِ كان يقارن ما وقع بما أُذِن به**.

وأخطرُ ما في ذلك أنّ التدقيقَ يصير **شاهدَ زورٍ لا شاهدَ صدق**: `ExecutionRecord`
يكتب `action` و`fingerprint` **من الطلب**، فيقول السجلُّ «نُفِّذ خصمٌ من الحساب أ»
بينما الذي جرى تحويلٌ من الحساب ب. فالوثوقُ به وثوقٌ بالنيّةِ لا بالواقع — وهذه
القاعدةُ العليا 15 بحرفها.

### 29.3 القرار — أثرٌ **مُعلَنٌ ثمّ مُحقَّقٌ ثمّ مُطبَّق**

لا مُنفِّذَ موازٍ ولا محرّكَ ثالث (القاعدتان 5 و6): `execute_under_contract` تلفُّ
`execute` نفسَها وتمرُّ من تقييمِها الدستوريِّ نفسِه. الجديدُ هو **حصرُ المُنفِّذ**
في ثلاثِ بوّاباتٍ متتالية:

| # | البوابة | متى | ما يقع عند المخالفة |
|---|---|---|---|
| 1 | **حدُّ النطاق** | عند ربطِ العقد، **قبل التقييمِ الدستوريّ** | `EffectOutOfScopeError` — ولا حكمَ ولا أثرَ ولا حدثَ أصلًا |
| 2 | **الحكمُ الدستوريّ** | `execute` نفسُها | `SovereigntyViolation` كما كان |
| 3 | **حدُّ العقد** | بعد `planner` وقبل `applier` | `ContractBreach` — **ولا يُطبَّق شيء** |

و`planner` يُرجِع الآثارَ **ولا يملك تطبيقَها**؛ و`applier` هو الطريقُ الوحيدُ إلى
حالةِ الدولةِ ولا يُستدعى إلّا على أثرٍ مشمولٍ بالعقد. فالمنعُ **سابقٌ** لا لاحق:
هذا فرقُ «كشفِ التجاوز» عن «استحالتِه».

### 29.4 المُنجَز

| الأصل | الفعل | المضمون |
|---|---|---|
| `core/sovereignty/contract.py` | أُنشئ (296 سطرًا) | `SovereignEffect` · `EffectKind` · `ExecutionContract` · `ExecutionOutcome` · `bind_contract` · `in_scope` · `digest_of_payload` · `ContractBreach` · `EffectOutOfScopeError` |
| `core/sovereignty/gateway.py` | وُسِّع | `execute_under_contract` + `contracts` + `contracted_executions` و`uncontracted_executions` في الفحصِ الذاتيّ |
| `core/sovereignty/security_events.py` | وُسِّع | `EXECUTION_CONTRACT_BREACH` بدرجة **CRITICAL** |
| `core/sovereignty/__init__.py` | وُسِّع | عشرةُ تصديراتٍ كسولةٍ للوحدةِ الجديدة |
| `tests/sovereignty/test_execution_contract.py` | أُنشئ | **40 اختبارًا** تقيس القدرةَ من البوابةِ بحالةِ دولةٍ حقيقيّة |

**قرارٌ في التصميم:** بصمةُ المطابقةِ هي **النوعُ والمورد** لا التفصيل. ولو دخل
التفصيلُ في المطابقةِ لصار كلُّ اختلافٍ في قيمةٍ نصّيّةٍ خرقًا للعقد، فيُعطَّل
العقدُ عمليًّا ويُلتَفُّ عليه بإعلاناتٍ فضفاضة — وهذا أسوأُ من غيابه. والحمولةُ
تُختصَر إلى `payload_digest` فلا يُخزَّن في العقدِ سرٌّ (القاعدة 23).

### 29.5 الأثرُ المقيس — لا استثناءٌ مرفوعٌ بل حالةٌ لم تتغيّر

القاعدةُ 13 تمنع الاكتفاءَ باختبارِ وحدةٍ يستدعي دالّةً مباشرة. فالاختباراتُ تبني
قاموسَ مواردَ يمثّل حالةَ الدولة، وتُمرِّر الأفعالَ **من البوابةِ نفسِها**، ثمّ
**تقيس القاموس**:

- مُنفِّذٌ مأذونٌ له بـ`treasury/account-A` حاول `treasury/account-B` → قيمةُ ب
  **بقيت `50`** ولم تُمَسّ.
- حاول `royal/crown-authority` → **بقيت `ABSOLUTE`**. سلطةُ التاجِ لا تُمَسُّ عبر
  تنفيذٍ تنفيذيّ.
- الحزمةُ المختلطة: أثرٌ مشروعٌ وأثرٌ مُهرَّبٌ معًا → **لم يقع حتّى المشروع**،
  لأنّ الفحصَ يسبق تطبيقَ أوّلِ أثرٍ في الحزمة.
- المُطبِّقُ لم يُستدعَ ولا مرّةً على أثرٍ غيرِ مشمول (مقيسٌ بعدّادٍ لا بنيّة).
- `treasury/account-A2` **ليس** فرعًا من `treasury/account-A` — فخُّ البادئةِ
  مقيسٌ ومُغلَق. وهدفٌ فارغٌ **لا يشمل شيئًا**: طلبٌ بلا هدفٍ ليس إذنًا مفتوحًا.
- المنعُ الدستوريُّ **يسبق** العقد: `amend_constitution` من الفرعِ التنفيذيِّ
  يُمنَع ولو كان عقدُه سليمًا تمامًا.
- الخرقُ يُثبَّت في **السجلِّ الدستوريّ** بـ`ledger_entry_hash` لا في الذاكرةِ
  فحسب (القاعدة 17)، ورسالتُه **تُسمّي المورد المخالف** ولا تُلمِّح.

### 29.6 البوّاباتُ — أرقامٌ مقيسةٌ لا موصوفة

| البوابة | النتيجة |
|---|---|
| `tests/` كاملةً | **1008 ناجحًا · 1 متجاوَزٌ بصدق** (كان 968 · +40) |
| `tests/sovereignty/` | 360 ناجحًا · 1 متجاوَز |
| تغطيةُ فروعِ النواةِ السياديّة | **94.19%** (كانت 92.97 · الحدُّ 90) · `contract.py` **100%** |
| تغطيةُ فروعِ النواةِ الدستوريّة | 95.45% (الحدُّ 90) |
| تدقيقُ الحقيقة `--ratchet` | **97 مخالفةً — ثابتٌ بلا زيادة** · 0 أقاليمَ مُثبَتة |
| المصالحةُ الدستوريّة | **20 استنتاجًا — مطابقٌ لخطِّ الأساسِ حرفًا** (RECON-001×5 · 002×5 · 003×3 · 006×2 · normative_unsealed×5) |
| `prove_supreme_authority` · `verify_crown_root_of_trust` · `crown-check` · `sovereignty-check` | نجحت جميعًا |
| الهويّة · الأختام · `ruff` | نجحت |

ولم تُدخَل مخالفةٌ واحدةٌ جديدةٌ في تدقيقِ الحقيقة: لا `Silent Fallback` ولا
مصدرَ حقيقةٍ في الذاكرة (القاعدتان 16 و17).

### 29.7 ما ليس مُثبَتًا — بصراحة

- **الدولةُ اليومَ فيها مساران: بعقدٍ وبلا عقد.** `execute` القديمةُ **باقيةٌ
  تعمل** لأنّ هدمَها هدمُ أصلٍ (القاعدتان 3 و11): يستدعيها `gateways.py`
  و`cli.py` وجسرُ النواةِ التنفيذيّةِ الفدراليّة. ولا يُخفى ذلك: الفحصُ الذاتيُّ
  يُعلن `uncontracted_executions` عددًا صريحًا. وتحويلُ المُنادينَ عملٌ تالٍ.
- **لا ذرّيّةَ ولا تراجُع.** إن خالف `planner` **بعد** أن طُبِّق أثرٌ مشروعٌ سابقٌ
  في الحزمةِ نفسِها، فالمشروعُ **باقٍ** ويظهر في `applied_effects` ولا يُلغى.
  التعويضُ والذرّيّةُ عملُ 1H (Idempotency) و1I (Fail-Closed).
- **`ExecutionRecord.executed = True` يُكتَب قبل استدعاءِ المُنفِّذ.** وهذا خللٌ
  **قائمٌ من قبلِ 1E** كشفه العقدُ ولم يُصلحه: عند الخرقِ يقول السجلُّ «نُفِّذ»
  ثمّ يُلحَق به `CONTRACT_BREACH`. ولم يُعدَّل الأثرُ الأوّلُ ولم يُحذَف
  (القاعدة 22) — يُسجَّل هنا فجوةً معلومةً لا تُطوى، وتصحيحُ دلالةِ `executed`
  عملُ 1I. واختبارٌ صريحٌ يُثبِت هذا الترتيبَ ولا يتظاهر بغيره.
- **العقدُ لا يفرض نفسَه على مَن لم يطلبه.** لا شيءَ اليومَ يمنع مكوّنًا جديدًا من
  استعمالِ `execute` بلا عقد. جعلُ العقدِ إلزاميًّا يلزمه فصلُ PDP/PEP (1F) وحرسٌ
  ساكنٌ ضدّ المسارِ العاري (1M).
- **`payload_digest` اختياريٌّ ولا يُتحقَّق منه.** العقدُ يحمله ولا يقارن الحمولةَ
  الفعليّةَ به؛ التحقّقُ من المضمونِ عملٌ لاحق.
- **لا يُعلَن إقليمٌ PROVEN.** التدقيقُ ما زال 0 أقاليمَ مُثبَتة.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **الاعتماداتُ الثلاثةُ ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**
- **التاجُ ما زال `unprovisioned`** بانتظارِ مراسمِ التنصيبِ البشريّة.

---

## 30. STAGE 1F — فصلُ موضعِ القرارِ عن موضعِ الإنفاذ (2026-08-18)

> **الدعوى المُقاسة:** يستطيع مكوِّنٌ أن **يُنفِّذ** قرارًا سياديًّا وهو **لا يملك**
> أن يتّخذه — لا لأنّه يمتنع، بل لأنّه لا يحوز ما يتّخذ به.

### 30.1 الفجوةُ كما قِيسَت لا كما تُصوَّر

البحثُ عن `PDP` و`PEP` في المستودعِ كلِّه لم يُرجِع مفهومًا واحدًا: كلُّ ما ظهر
`PEP 562` في تعليقاتِ الاستيرادِ المتأخّر. أي أنّ **الفصلَ لم يكن ناقصًا بل
معدومًا**.

وفي `core/sovereignty/gateway.py` القرارُ والإنفاذُ **نداءان متتاليان في التابعِ
نفسِه**: `self._engine.evaluate(...)` ثمّ `executor()`، ولا أثرَ بينهما. ويترتّب
على ذلك ثلاثةُ حدودٍ حقيقيّة:

| # | الحدُّ | أثرُه الملموس |
|---|-------|---------------|
| 1 | لا أثرَ قرارٍ يُحمَل | من أراد أن يُنفِّذ لزمه أن يملك بوابةً بمحرّك — فصارت **كلُّ نقطةِ إنفاذٍ نقطةَ قرار** |
| 2 | لا فرقَ بين «أحمل إذنًا» و«أملك أن آذن» | ولا سبيلَ إلى قياسِ الفرق |
| 3 | لا إنفاذَ على بُعد | المُنفِّذُ يجري **داخل** البوابة: لا عمليّةَ أخرى ولا وقتَ لاحقٌ يُنفِّذ قرارًا صدر |

والشاهدُ الملموسُ على الأوّل قائمٌ في المستودع:
`federal/.../executive_core/sovereignty_bridge.py` — `ConstitutionalAuthorizer`
يبني `SovereignGateway()` **لنفسِه** في `_build_gateway`. فالنواةُ التنفيذيّةُ
الفدراليّةُ كانت **الحاكمَ والمُنفِّذَ معًا**.
...
### 30.2 القرارُ الهندسيّ ولماذا لا يخرق القاعدتين 5 و6

**لا محرّكَ ثالث، ولا منطقَ قرارٍ ثانٍ.** `SovereignGateway.decide` **تمرُّ من
`execute` نفسِها حرفيًّا**، وتُمرِّر مُنفِّذًا لا يمسُّ حالةً بل يلتقط أثرَ الحكم.
فالتباعدُ بين قرارِ `decide` وقرارِ `execute` **ممتنعٌ بنيويًّا لا اتّفاقًا**: ليس
ثمّة نسختان لتفترقا. وهذا حراسةُ القاعدتين بالبناءِ لا بالوصيّة، ومع ذلك يقيسه
اختبارٌ صريحٌ على ثلاثةِ أفعالٍ لئلّا يُصدَّق الادّعاءُ بلا شاهد.

ونطاقُ الإذنِ هو **عقدُ 1E نفسُه** (`bind_contract` وبصماتُ الآثار)، فلا مفهومَ
نطاقٍ ثانٍ موازٍ (القاعدة 6). وبوّابةُ النطاقِ الأولى تعمل قبل الحكم: أثرٌ خارجَ
هدفِ الطلبِ يُرفَض **قبل** أن يُصدَر إذنٌ أصلًا.

### 30.3 لماذا Ed25519 لا HMAC — وهذا هو الفصلُ كلُّه

لو وُقِّع الإذنُ بمفتاحٍ متماثل لَلزم أن يملك المُنفِّذُ مفتاحَ التحقّقِ نفسَه،
ومن ملك مفتاحَ التحقّقِ المتماثلِ ملك مفتاحَ التوقيع — **فيأذن لنفسِه**، ويعود
الفصلُ لفظًا بلا حقيقة.

فالإذنُ يُوقَّع بمفتاحٍ **غيرِ متماثل** يحوزه موضعُ القرارِ وحدَه
(`_permit_key`، خاصٌّ ولا يُصدَّر في واجهةٍ عامّة)، ولا يُعطى موضعُ الإنفاذِ إلّا
`verifying_key_hex`. وامتناعُه عن الإذنِ لنفسِه **امتناعُ عجزٍ لا امتناعُ أدب**.

ومجالُ التوقيعِ `AMOS-FEDERATION/ENFORCEMENT-PERMIT/v1` داخلٌ في الموقَّع، فلا
يُقرَأ توقيعُ إذنٍ توقيعَ مرسومٍ أو تحدّي تنسيب.

### 30.4 ما بُني

| المُنتَج | الوصف |
|---------|-------|
| `core/sovereignty/enforcement.py` (351 سطرًا) | `EnforcementPermit` · `PolicyEnforcementPoint` · `ConsumedPermitLedger` · `issue_permit` · `sign_permit` وخمسةُ أخطاءٍ مُصنَّفة |
| `SovereignGateway.decide` | موضعُ القرار: يُصدِر إذنًا مارًّا من `execute` نفسِها |
| `SovereignGateway.verifying_key_hex` | المفتاحُ العامُّ يُصدَّر، والخاصُّ يُحجَب |
| `ExecutionRecord.enforcement` | `DIRECT` أم `PERMIT_ISSUED` — يُكتَب **عند** الكتابة لا بتعديلٍ لاحق (القاعدة 22) |
| `self_check()["permits_issued"]` | عدّادٌ مُعلَنٌ لا مخفيّ |
| `ConstitutionalAuthorizer.request_permit` / `.enforcement_point` | مخرجُ النواةِ الفدراليّةِ من كونها حاكمةً ومُنفِّذةً معًا |

**ولم يُهدَم شيء:** `execute` و`execute_under_contract` و`review` وسلوكُ
`guard` الفدراليّ لم يتغيّر منها حرف. الإضافةُ إضافةٌ لا استبدال (القاعدة 3).

### 30.5 حدودُ الإذنِ الأربعة — وكلٌّ منها مقيس

1. **لا يُوسَّع.** أثرٌ لم تُعلِنه بصماتُ الإذنِ لا يقع، **ولا يقع معه المأذونُ به
   أيضًا**: الفحصُ كلُّه قبل تطبيقِ أوّلِ أثر.
2. **لا يُعاد.** يُستهلَك مرّةً واحدة، والاستهلاكُ **على القرصِ لا في الذاكرة**
   (القاعدة 17) — فمُنفِّذٌ ثانٍ بذاكرةٍ نظيفةٍ يقرأ القرصَ فيرفض. ولو كان في
   الذاكرةِ لكانت إعادةُ الاستعمالِ ممكنةً بعمليّةٍ أخرى، وهو الطريقُ الذي
   يُهاجَم به عمليًّا.
3. **لا يبقى.** عمرٌ افتراضيٌّ 300 ثانية، وإذنٌ بعمرٍ غيرِ موجَبٍ يُرفَض **عند
   الإصدار**: الإذنُ الذي لا ينتهي صكُّ ملكيّةٍ لا رخصةُ لحظة.
4. **لا يُزوَّر.** كلُّ حقلٍ داخلٌ في التوقيع — ولا حقلَ «تجميليَّ» خارجَه. وهذا
   مقيسٌ بتحريفِ **سبعةِ حقولٍ** واحدًا واحدًا.

**واختيارٌ مُعلَنٌ لا سهو:** الاستهلاكُ **قبل** التطبيق. لو استُهلِك بعده لأمكن
أن يُطبَّق أثرٌ ثمّ يسقط تثبيتُ الاستهلاكِ فيُعاد الإذنُ ويُطبَّق الأثرُ مرّتين.
والخسارةُ في الاتّجاهِ الآخر إذنٌ ضاع — **وضياعُ إذنٍ أهونُ من أثرٍ مكرّر**.
واختبارٌ صريحٌ يُثبِّت هذا الاختيارَ بمُطبِّقٍ ينهار.

### 30.6 القياسُ — من البوابةِ وعلى حالةِ دولةٍ حقيقيّة

القاعدة 13 تمنع الاكتفاءَ باختبارِ وحدة. فكلُّ منعٍ هنا **يُقاس بقاموسِ حالةٍ لم
يتغيّر**، لا بأنّ استثناءً ارتفع.

| البند | العدد |
|-------|------|
| اختباراتُ 1F الجديدة | **46** |
| `tests/sovereignty/` | **406 نجحت · 1 تخطّت** |
| المجموعةُ الجذريّة `tests/` | **1054 نجحت · 1 تخطّت** (كانت 1008) |
| تغطيةُ `enforcement.py` | **100٪ فرعيّة** |
| تغطيةُ نواةِ السيادة | **94.85٪** فرعيّة (كانت 94.19٪) |
| تغطيةُ نواةِ الدستور | **95.45٪** |
| `ruff` · الهويّة · البصمة · السلطةُ العليا · جذرُ التاج · CLIs | **كلُّها خضراء** |
| تدقيقُ الصدقِ `--ratchet` | **97 مخالفة — ثابتٌ بلا زيادة** |
| المصالحةُ الدستوريّة | **20 نتيجةً — بلا تغيير** |

وأبرزُ ما قيس: مُنفِّذٌ يحاول أن يأذن لنفسِه بمفتاحٍ من عندِه فيُرفَض ولا تتغيّر
الحالة · إذنٌ يعبُر الحدودَ **مُسلسَلًا نصًّا** ثمّ يُنفَّذ (لا كائنٌ مشترك) ·
`PolicyEnforcementPoint.__slots__` لا تحوي إلّا `verifying_key` و`consumed` ·
مصدرُ `enforcement.py` لا يستورد محرّكًا ولا بوابة · إذنُ بوابةٍ لا يُقبَل عند
مُنفِّذِ بوابةٍ أخرى · سقوطُ الكتابةِ لا يترك سجلَّ استهلاكٍ نصفيًّا.

### 30.7 ما صحَّحه القياسُ في التصميم

- **افترضتُ أن يُرفَض «الإذنُ الفارغ» عند المُنفِّذ، فكشف القياسُ أنّ المنعَ
  أسبق:** `bind_contract` من 1E يرفض العقدَ بلا أثرٍ مُعلَن أصلًا. فأُبدِل
  الاختبارُ ليقيس المنعَ **عند المنبع**، وسُجِّل ما قِيسَ لا ما أُريد.
- **`decision_kind` و`authority_layer` كانا يخرجان فارغَين** لأنّ العقدَ يُربَط
  **قبل** الحكم. فرُبِط الحقلان بالحكمِ الصادرِ نفسِه؛ ووضعُ صفرِ العقدِ مكانَ
  الحكمِ كان سيكون **كذبًا صامتًا في وثيقةٍ موقَّعة**.
- **`ExecutionRecord` كان سيقول «نُفِّذ» عن إصدارِ رخصة.** فأُضيف حقلُ
  `enforcement` يُكتَب عند الكتابةِ لا بتعديلٍ لاحق.

### 30.8 ما ليس مُثبَتًا — بصراحة

- **الفصلُ متاحٌ لا مفروض.** `execute` المباشرةُ باقيةٌ تعمل، و`guard` الفدراليُّ
  ما زال يسلكها. **فما زالت النواةُ التنفيذيّةُ تملك بوابةً — أي ما زالت نقطةَ
  قرارٍ ونقطةَ إنفاذٍ معًا في المسارِ الافتراضيّ.** ما أُنجِز أنّ لها **مخرجًا
  مقيسًا** الآن، لا أنّها خرجت. والفرضُ يلزمه حرسٌ ساكنٌ (1M).
- **مفتاحُ التوقيعِ عابرٌ مع العمليّة.** يُولَّد عند إنشاءِ البوابةِ ولا يُحفَظ،
  فإذنٌ صدر قبل إعادةِ التشغيلِ لا يُقبَل بعدها. وهذا **مُغلَقٌ لا مفتوح** (يُرفَض
  لا يُقبَل)، لكنّه ليس إدارةَ مفاتيحَ حقيقيّة: ربطُ مفتاحِ القرارِ بجذرِ التاجِ
  عملٌ تالٍ.
- **موضعُ الإنفاذِ لا يسجّل حدثًا أمنيًّا عند التزوير.** يرفع استثناءً صريحًا
  (لا ابتلاعَ — القاعدة 16) لكنّه لا يكتب في `SecurityEventLog`، لأنّ حملَه سجلًّا
  أمنيًّا يجرُّ إليه تبعيّاتِ النواةِ التي قُصِد تجريدُه منها. وصلُ التزويرِ
  بالسجلِّ الأمنيّ عملٌ لاحقٌ في 1L/1M.
- **`ExecutionRecord.executed=True` ما زال يُكتَب قبل نداءِ المُنفِّذ** — عيبٌ
  سابقٌ على 1E و1F، كشفه العقدُ ولم يُصلِحه، ومؤجَّلٌ إلى 1I.
- **لا يُعلَن إقليمٌ PROVEN.** التدقيقُ ما زال 0 أقاليمَ مُثبَتة.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **الاعتماداتُ الثلاثةُ ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**
- **التاجُ ما زال `unprovisioned`** بانتظارِ مراسمِ التنصيبِ البشريّة.
...
## 31. STAGE 1G — جدارُ الاختصاصِ القضائيّ: حدودُ السلطةِ القضائيّةِ قبلَ التجاوز (2026-08-18)

> **الدعوى المُقاسة:** القضاءُ لا حدودَ لاختصاصِه في النواةِ السياديّةِ — لا ما
> يمنعُ المحكمةَ الفدراليّةَ من الفصلِ في قضيّةِ ولاية، ولا ما يمنعُ القاضيَ من
> خارجِ النطاقِ من الجلوس، ولا ما يمنعُ الحكمَ القضائيّ من أن يكونَ تنفيذًا.

### 31.1 الفجوةُ كما قِيسَت لا كما تُصوَّر

البحثُ عن `jurisdiction` في نواةِ السيادةِ لم يُرجِع جدارًا: كلُّ ما ظهر في
`federal/executive/services/.../federal_judiciary/jurisdiction.py` — وهو في طبقةِ
الخدماتِ لا في النواةِ السياديّة. وأربعةُ حدودٍ حقيقيّةٍ غائبة:

| # | الحدُّ | أثرُه الملموس |
|---|-------|---------------|
| 1 | لا حدودَ اختصاصٍ في النواة | محكمةٌ فدراليّةٌ تستطيعُ الفصلَ في قضيّةِ ولايةٍ بترقيةٍ ضمنيّة |
| 2 | لا فصلًا بين الحكمِ والتنفيذ | لم يكن صريحًا أنّ الحكمَ أثرٌ لا تنفيذ |
| 3 | لا حمايةً للمرجعيّةِ الملكيّة | لا ما يمنعُ القضاءَ من نقضِ مرسومٍ ملكيّ |
| 4 | لا تصنيفًا للأثرِ القضائي | لا ما يمنعُ القضاءَ من إنشاءِ أثرٍ ماليٍّ أو تنفيذيّ |

### 31.2 القرارُ الهندسيّ

**جدارٌ دستوريٌّ في النواةِ السياديّةِ، لا استثناءاتٌ في القواعد.** بُني
`core/sovereignty/jurisdiction.py` كجدارٍ بنيويٍّ يُعرّفُ حدودَ الاختصاصِ القضائيّ
ويمنعُ التجاوزَ قبلَ وقوعِه. ولا يُبنى كاستثناءاتٍ `if judicial: deny` بل كفحصٍ
كاملٍ في ممرٍّ واحد.

الجدارُ لا يملكُ التنفيذَ: لا يستوردُ `ExecutiveCore` ولا `StateTreasury`. وامتناعُه
عن التنفيذِ **بنيويٌّ لا سلوكيّ** — لا يوجدُ فيه مسارٌ للصرفِ أو للتقديم.

### 31.3 ما بُني

| المُنتَج | الوصف |
|---------|-------|
| `core/sovereignty/jurisdiction.py` (407 أسطر) | `JurisdictionWall` · `JudicialAction` · 3 نطاقات · 8 أفعال قضائيّة · 23 فعلًا ممنوعًا · 2 اختصاص ملكي حصري |
| `JUDICIAL_SCOPES` | مصدرُ الحقيقةِ الأعلى للنطاقاتِ القضائيّة: `FEDERAL` · `STATE` · `INSTITUTION` |
| `FORBIDDEN_JUDICIAL_ACTIONS` | 23 فعلًا ممنوعًا على القضاء: تشرّيع · تنفيذ · ميزانيّة · مساس بالتاج |
| `ROYAL_JUDICIAL_PREROGATIVES` | فعلانِ ملكيّانِ حصريّان: `pardon` · `overturn_judicial_ruling` |
| `JUDICIAL_EFFECT_KINDS` / `NON_JUDICIAL_EFFECT_KINDS` | تصنيفُ الأثر: قضائيّ (CREATE/WRITE/READ) مقابلَ تنفيذيّ (DELETE/TRANSFER/EXTERNAL) |
| `JurisdictionWall.evaluate()` | بوّابةٌ كاملةٌ تُفحصُ فيها كلُّ الحدودِ بالترتيب |
| `WALL` | مَثيلٌ واحدٌ للجدار — لا حالةً متغيّرة، فالحدودُ دستوريّةٌ ثابتة |
| `tests/sovereignty/test_jurisdiction_wall.py` (412 سطرًا) | 78 اختبارًا في 6 تصنيفات |

**ولم يُهدَم شيء:** لا تغييرَ في `gateway.py` ولا في `enforcement.py` ولا في
`contract.py` ولا في `federal_judiciary`. الإضافةُ إضافةٌ لا استبدال.

### 31.4 القدراتُ المُثبَتة — مقيسةً لا موصوفة

| القدرة | الدليل |
|--------|--------|
| محكمة فدرالية لا تملك قضايا الولايات | `test_federal_court_cannot_adjudicate_state_case` — استثناءٌ صريحٌ + لا تغيُّر حالة |
| قاضٍ خارج نطاقه مرفوض | `test_judge_outside_scope_denied` |
| القضاء لا يُشرّع | `test_legislate_rejected_as_overreach` + 23 فعلًا ممنوعًا مُختبَرًا كاملًا |
| القضاء لا يُنفّذ | `test_execute_rejected_as_overreach` |
| القضاء لا يُخصّص ميزانيّة | `test_allocate_budget_rejected_as_overreach` |
| تعليقُ سياساتِ مجلس السياسات | `test_court_cannot_suspend_policy_council_policy` — القضاءُ لا يُعلّقُ سياساتِ المجلس |
| الحكمُ أثرٌ قضائيّ لا تنفيذي | `test_delete_effect_rejected` · `test_transfer_effect_rejected` |
| لا سلطةَ فوقَ التاج | `test_royal_prerogatives_rejected` (عفو + نقض حكم) · `test_court_cannot_overturn_royal_decree` |
| مرجعيّةٌ استشاريّةٌ على المرسوم | `test_court_can_adjudicate_involving_royal_decree_advisory` — الفصلُ مسموح، النقضُ لا |
| علاقةُ مجلس السياسات | `test_court_cannot_enact_policy_council_policy` · `test_court_cannot_repeal_policy_council_policy` — القضاءُ لا يُقرّرُ ولا يُلغي سياساتِ المجلس |
| نطاقٌ إداريٌّ مرفوض قضائيًّا | `test_department_scope_rejected` |
| مؤسّسةُ المحكمةِ لا تملكُ مؤسّسةً أخرى | `test_institution_court_cannot_adjudicate_other_institution` |
| مصدرُ حقيقةٍ واحد | `test_judicial_scopes_match_expected` · `test_forbidden_actions_no_overlap_with_allowed` |
| الجدارُ بلا تجاوز | `test_wall_has_no_bypass_parameter` — لا `force`/`bypass`/`override` في توقيعِ `evaluate` |
| الجدارُ عديمُ الحالة | `test_wall_is_stateless` — لا حقولَ حالةٍ متغيّرة |

### 31.5 القياسُ — أرقامٌ مقيسة

| البند | العدد |
|-------|------|
| اختباراتُ 1G الجديدة | **78** |
| `tests/sovereignty/` | **481 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة (استيرادُ حزمة `amos_federation` الناقصة في بيئةِ الساندبوكس)** |
| المجموعةُ الجذريّة `tests/` | **1129 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة** (كانت 1054) |
| تغطيةُ `jurisdiction.py` | **100٪ فرعيّة** |
| `ruff` | نظيف |
| تدقيقُ الصدقِ `--ratchet` | **97 مخالفة — ثابتٌ بلا زيادة** |
| المصالحةُ الدستوريّة | **20 نتيجة — بلا تغيير** |

### 31.6 ما ليس مُثبَتًا — بصراحة
...
- **لا استئنافَ ولا إحالةً بين المحاكم.** نقلُ قضيّةٍ من نطاقٍ إلى نطاقٍ يحتاج
  إجراءً قضائيًّا مُصمَّمًا — وهذا دَينٌ معلن.
...
- **لا ربطًا مفروضًا بطبقةِ الخدمات.** `federal_judiciary` في طبقةِ الخدماتِ لها
  منطقُها القائم (`assert_jurisdiction_match`)، وهذا الجدارُ هو المرجعُ الدستوريّ
  لها لا بديلُها. ويُتوقّعُ اختبارٌ ساكنٌ يُثبتُ تطابقَ `JUDICIAL_SCOPES` مع
  `federal_judiciary.models.JURISDICTIONS` عند توفرِ الحزمة.
- **لا يُعلَن إقليمٌ PROVEN.** التدقيقُ ما زال 0 أقاليمَ مُثبَتة.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **الاعتماداتُ الثلاثةُ ما زالت تحتاج تدويرًا — قرارٌ بشريّ.**
- **التاجُ ما زال `unprovisioned`** بانتظارِ مراسمِ التنصيبِ البشريّة.

### 31.7 الأفعالُ الممنوعةُ على القضاء — تصنيفٌ دستوريّ

| التصنيف | الأفعال | السندُ الدستوريّ |
|---|---|---|
| لا تُشرّع | `legislate` · `amend_law` · `enact_policy` · `suspend_policy` · `repeal_policy` | المادة الثالثة · 1 |
| لا تُنفّذ | `execute` · `deploy_service` · `dispatch_agent` · `deploy_production` | المادة الثالثة · 1 |
| لا تُخصّص ميزانيّة | `allocate_budget` · `disburse_funds` · `transfer_treasury` | المادة الثالثة · 4 |
| لا سلطةَ فوقَ التاج | `overturn_royal_decree` · `suspend_royal_decree` · `nullify_royal_decree` · `veto_royal_decree` · `review_royal_decree` · `impeach_king` · `depose_king` · `amend_royal_authority` | المادة العاشرة · 1 و 3 |
| لا ينشئُ ولاياتٍ ولا مؤسّسات | `create_state` · `dissolve_state` · `create_institution` · `dissolve_institution` | المادة العاشرة · 2 |
| اختصاصٌ ملكيٌّ حصريّ | `pardon` · `overturn_judicial_ruling` | المادة العاشرة · 2 · 7 |

### 31.8 ما لا يجوزُ إعادةُ فتحِه

- لا تُعَد فتحَ حدودُ النطاقِ (المساواةُ الصريحةُ) إلا إذا تغيّرَ نصُّ المادةِ الثالثة.
- لا تُعَد فتحَ قائمةَ الأفعالِ الممنوعةِ إلا إذا صدرَ مرسومٌ ملكيٌّ أو تعديلٌ دستوريّ.
- لا تُعَد فتحَ تصنيفَ الأثرِ القضائيّ إلا إذا تغيّرَ تعريفُ `EffectKind` في `contract.py`.

### 31.9 الخطوةُ التالية

المرحلةُ التاليةُ المعتمدةُ وفقَ ترتيبِ Stage 1 هي **1H — Idempotency**
(الذرّيّةُ والتراجعُ عن الأثر). ويُتوقّعُ أن تبنيَ قدرةَ التعويضِ والتراجعِ عن
الأثرِ المُطبَّق، وهي تعتمدُ على عقدِ 1E وفصلِ 1F.

ولا يجوزُ الانتقالُ إلى 1H قبل:
1. إثباتِ أنّ 1G متاحةٌ ومقيسةٌ (تمّ).
2. توثيقِ هذا التسليم (تمّ).
3. تحديثِ `PROJECT_STATE.md`.

---

## 32. STAGE 1H — الذرّيّةُ ومنعُ تكرارِ الأثر: عمليّةٌ واحدةٌ تُنتِجُ أثرًا واحدًا (2026-08-18)

> **الدعوى المُقاسة:** بعد 1E (العقد) و1F (الإذن) و1G (الاختصاص)، لا حمايةَ
> من تكرارِ الأثر: لو أُعيدَ الطلبُ نفسُه مرّتين — تسلسليًّا أو متزامنًا —
> لطُبِّقَ الأثرُ مرّتين. ولو فشلتِ العمليّةُ في منتصفِها لبقيتِ الدولةُ في
> حالةٍ غيرِ معرّفة.

### 32.1 الفجوةُ كما قِيسَت

بعد 1E/1F/1G، المسارُ السياديّ يعملُ مرّةً واحدةً بشكلٍ صحيح، لكن لا حمايةَ له
من إعادةِ الطلب. `ConsumedPermitLedger` (1F) يمنعُ إعادةَ استعمالِ الإذن، لا
إعادةَ استعمالِ النتيجة. و`SovereignGateway.execute` لا يفحصُ هل نُفِّذَ هذا
الطلبُ من قبل.
...
| # | الحدُّ | أثرُه الملموس |
|---|-------|---------------|
| 1 | لا حجزًا قبل التنفيذ | طلبانِ متتابعان يُنتِجانِ أثرين |
| 2 | لا تزامنًا | أربعةُ طلباتٍ متزامنة تُنتِجُ أربعةَ آثار |
| 3 | لا استعادةً من الانقطاع | عمليّةٌ منقطعةٌ = حالةٌ مجهولة |
| 4 | لا حمايةَ للأثر الخارجيّ | إرسالٌ خارجيٌّ يتكرّر دون ضبط |

### 32.2 القرارُ الهندسيّ

**حارسٌ يلفُّ المسارَ القائم — لا محرّكٌ موازٍ.** بُني `IdempotencyGuard`
كحارسٍ يحمي المسارَ السياديّ القائم (قرار -> إذن -> تنفيذ) من التكرار، دون أن
يُنشئَ محرّكَ قرارٍ ثانيًا أو مسارَ تنفيذٍ بديلًا. الحارسُ يأخذُ العمليّةَ
القائمةَ ويحميها بثلاثِ طبقات: حجزٌ على القرص قبلَ التنفيذ، تثبيتُ النتيجةِ
بعده، واستعادةٌ من الانقطاع.

ولا يملكُ `force` ولا `bypass` ولا `override`، كالجدارِ في 1G.

### 32.3 ما بُني

| المُنتَج | الوصف |
|---------|-------|
| `core/sovereignty/idempotency.py` (801 سطرًا) | `IdempotencyGuard` · `IdempotencyLedger` · `IdempotencyKey` · `OperationStatus` · `compute_fingerprint` · `run_effects_once` |
| `IdempotencyKey` | مفتاحُ ذرّيّةٍ مكوّنٌ من نطاقٍ وقيمة — يمنعُ التصادمَ بين الوحدات |
| `OperationStatus` | 8 حالاتٍ معرّفة: `RESERVED` · `RUNNING` · `SUCCEEDED` · `FAILED_RETRYABLE` · `FAILED_FINAL` · `INTERRUPTED` · `RECOVERY_REQUIRED` · `EXTERNAL_PENDING` — لا `UNKNOWN` |
| `IdempotencyLedger` | سجلٌّ على القرصِ — يبقى بعدَ سقوطِ العمليّة، يقرأُه سجلٌّ جديد |
| `IdempotencyGuard.run_once()` | حجزٌ -> تنفيذٌ -> تثبيتٌ، أو إعادةُ نتيجةٍ سابقة. قفلٌ لكلِّ مفتاح يمنعُ سباقاتِ التزامن |
| `compute_fingerprint()` | بصمةُ العمليّة: النطاق + الفعل + الهدف + الآثار + الفاعل |
| `tests/sovereignty/test_idempotency.py` (1126 سطرًا) | 66 اختبارًا في 10 تصنيفات |

**ولم يُهدَم شيء:** لا تغييرَ في `contract.py` ولا `enforcement.py` ولا
`jurisdiction.py` ولا `gateway.py`. الإضافةُ إضافةٌ لا استبدال.

### 32.4 القدراتُ المُثبَتة — مقيسةً لا موصوفة

| القدرة | الدليل |
|--------|--------|
| طلبٌ واحد -> أثرٌ واحد | `test_first_execution_succeeds` — تنفيذٌ واحد، نتيجة، لا إعادة |
| تكرارٌ تسلسلي -> أثرٌ واحد | `test_sequential_duplicate_returns_replay` — الثانيةُ إعادةٌ لا تنفيذ |
| نجاحٌ ثمّ retry -> لا أثرٍ إضافيّ | `test_success_then_retry_no_extra_effect` — 5 طلبات، تنفيذٌ واحد |
| فشلٌ ثمّ retry -> لا أثرٍ مزدوج | `test_failed_then_retry_no_double_effect` — فشلٌ ثمّ استعادةٌ ثمّ نجاح |
| تكرارٌ متزامن -> أثرٌ واحد | `test_concurrent_duplicate_single_effect` — 4 طلباتٍ متزامنة، تنفيذٌ واحد |
| مفاتيحُ مختلفة -> تنفيذٌ مختلف | `test_concurrent_different_keys_all_execute` — 4 مفاتيح، 4 تنفيذات |
| بصمةٌ مختلفة على المفتاحِ نفسِه = رفض | `test_changed_fingerprint_rejected` — `IdempotencyKeyReuseError` |
| تصادمٌ بين النطاقات = مسموح | `test_cross_scope_key_no_collision` — مفتاحٌ نفسُه في نطاقينِ مختلفين |
| ثباتٌ بعدَ إعادةِ التشغيل | `test_new_guard_returns_replay_after_restart` — حارسٌ جديد يُعيدُ النتيجةَ السابقة |
| استعادةٌ من الانقطاع | `test_interrupted_record_survives_restart` — سجلٌّ منقطعٌ يُستعاد |
| أثرٌ خارجيّ يُسجَّل | `test_external_effect_marked_in_record` — `has_external_effect=True` بعدَ نجاحِ `run_once()` |
| الأثرُ الخارجيُّ مرفوضٌ في `run_effects_once` | `test_external_effect_rejected` — يحتاج outbox منفصل |
| سجلُّ التدقيق كامل | `test_record_has_key_and_fingerprint` · `test_record_has_timestamps` · `test_record_has_attempt_history` |
| الإعادةُ لا تُعدِّلُ السجلَّ التاريخيّ | `test_replay_does_not_modify_record` |
| الحارسُ بلا تجاوز | `test_guard_has_no_bypass_parameter` — لا `force`/`bypass`/`override` |
| الحارسُ لا يقررُ سلطةً | `test_guard_does_not_decide_authority` — لا `issue_permit` ولا `SovereignGateway` في مصدره |
| تعارضُ تزامنٍ على عمليّةٍ جارية | `test_guard_conflict_on_running` — `IdempotencyConflictError` |
| ملفٌّ تالفٌ = استثناءٌ صريح | `test_ledger_corrupted_file_raises` — لا ابتلاعٌ صامت |
| **فشلٌ جزئيّ -> RECOVERY_REQUIRED** | `test_partial_failure_marks_recovery_required` — أثرٌ مُطبَّقٌ يُسجَّل، لا يُعاد |
| **إعادةُ محاولةٍ تُخطّي الآثارَ المُطبَّقة** | `test_retry_after_partial_failure_skips_applied_effects` |
| **الأثرُ الخارجيُّ مرفوضٌ في المسار الذرّيّ** | `test_external_effect_rejected` — يحتاج outbox منفصل |
| **سجلُّ الانتقالاتِ إضافيّ** | `test_transitions_are_append_only` — from/to/is_retry/timestamp |
| **الانتقالاتُ تبقى بعدَ إعادةِ التشغيل** | `test_transitions_survive_restart` |
| **تكاملُ 1F: ذرّيّةٌ + إذن** | `test_duplicate_retry_does_not_reconsume_permit` — إذنٌ لا يُعادُ استهلاكُه |
| **تكاملُ 1F: ذرّيّةٌ + أثر** | `test_duplicate_retry_does_not_reapply_effects` — أثرٌ واحد، 3 طلبات |
| **أثرٌ نُفِّذَ ثمّ رفعَ استثناءً = RECOVERY_REQUIRED** | `test_effect_applied_then_raises_marks_recovery` — pending_effect يُسجَّل |

### 32.5 القياسُ — أرقامٌ مقيسة

| البند | العدد |
|-------|------|
| اختباراتُ 1H الجديدة | **67** |
| `tests/sovereignty/` | **548 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة (استيرادُ حزمة `amos_federation` الناقصة)** |
| المجموعةُ الجذريّة `tests/` | **1196 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة** (كانت 1129) |
| تغطيةُ `idempotency.py` | **95% فرعيّة** |
| `ruff` | نظيف |
| تدقيقُ الصدقِ `--ratchet` | **97 مخالفة — ثابتٌ بلا زيادة** |
| المصالحةُ الدستوريّة | **20 نتيجة — بلا تغيير** |
| فحصُ الهويّة | ناجح |

### 32.6 ما ليس مُثبَتًا — بصراحة

- **الحارسُ متاحٌ لا مفروض.** كما في 1F و1G، لا شيءَ اليومَ يُلزِمُ المسارَ
  بالمرورِ عبر الحارس. الفرضُ يلزمه حرسٌ ساكنٌ (1M). **الحالة: AVAILABLE / VERIFIED / NOT YET ENFORCED.**
- **الأثرُ الخارجيُّ لا يُعالَجُ في المسارِ الذرّيّ المباشر.** `run_effects_once()`
  يرفضُ آثارَ `EffectKind.EXTERNAL` بصراحة. أمّا `run_once()` فيُسجِّلُ الأثرَ
  الخارجيَّ بعدَ نجاحِ التنفيذِ فقط — لو انهارتِ العمليّةُ بعدَ التطبيقِ وقبلَ
  التسجيل، قد يتكرّرُ الأثرُ. **outbox مقاومٌ للانهيار = عملٌ تالٍ، لم يُبنَ.**
- **لا توزيعٍ بين العمليّات.** السجلُّ ملفٌّ محليّ. التوزيعُ بين العُقَد عملٌ تالٍ.
- **مفتاحُ التوقيعِ عابرٌ مع العمليّة (من 1F).** إذنٌ صدر قبلَ إعادةِ التشغيلِ
  لا يُقبَل بعدها. الحارسُ يحمي العمليّة، لكنّ ربطَ الإذنِ بجذرِ التاج عملٌ تالٍ.
- **`COMPLETION = NOT YET COMPUTABLE`.**
- **التاجُ ما زال `unprovisioned`.**
- **3 أخطاء قائمة (amos_federation) — OPEN ISSUE / OUT OF CURRENT SCOPE.**

### 32.7 حالاتُ العمليّة — لا `UNKNOWN`

| الحالة | المعنى | نهائيّة؟ | قابلٌ للاستعادة؟ |
|---|---|---|---|
| `RESERVED` | محجوزةٌ قبلَ التنفيذ | لا | لا |
| `RUNNING` | جاريةٌ الآن | لا | لا |
| `SUCCEEDED` | نُفِّذت بنجاح | نعم | لا |
| `FAILED_RETRYABLE` | فشلت لكنّ retry ممكن | لا | نعم |
| `FAILED_FINAL` | فشلت نهائيًّا | نعم | لا |
| `INTERRUPTED` | انقطعت أثناء التنفيذ | لا | نعم |
| `RECOVERY_REQUIRED` | تتطلّبُ استعادةً يدويّة | لا | نعم |
| `EXTERNAL_PENDING` | أثرٌ خارجيٌّ معلّق | لا | لا |

### 32.8 ما لا يجوزُ إعادةُ فتحِه

- لا تُعَد فتحَ حالاتِ العمليّة (الثماني) إلا إذا تغيّرَ تعريفُ العمليّةِ السياديّة.
- لا تُعَد فتحَ بصمةَ العمليّة (`compute_fingerprint`) إلا إذا تغيّرَ تعريفُ الأثر.
- لا تُعَد فتحَ آليةَ القفلِ لكلِّ مفتاح إلا إذا ظهرَ نمطُ تزامنٍ مختلف.

### 32.9 الخطوةُ التالية

المرحلةُ التاليةُ المعتمدةُ وفقَ ترتيبِ Stage 1 هي **1I — Compensation**
(التعويضُ عن الأثرِ المُطبَّق). ويُتوقّعُ أن تبنيَ قدرةَ التراجعِ عن الأثرِ
الذي خالفَ العقد، وتعتمدُ على 1E (العقد) و1H (الذرّيّة).

ولا يجوزُ الانتقالُ إلى 1I قبل:
1. إثباتِ أنّ 1H متاحةٌ ومقيسةٌ (تمّ).
2. توثيقِ هذا التسليم (تمّ).
3. تحديثِ `PROJECT_STATE.md`.

---

## 33. STAGE 1I — التعويضُ عن الأثرِ المُطبَّق: معاملةٌ إمّا تتمُّ كاملةً أو لا تترك أثرًا (2026-08-18)

> **الدعوى المُقاسة:** بعد 1H، صارت العمليّةُ تُنفَّذُ مرّةً واحدة — لكن إن
> فشلت في منتصفِها بقيتِ الدولةُ **مشوَّهةً بأثرٍ نصفيّ**: 1H تُشخِّصُ الحالةَ
> بـ`RECOVERY_REQUIRED` ولا تُعالجُها، ومصدرُ 1E يُصرِّحُ «لا تراجعَ عن أثرٍ
> طُبِّق». فكلُّ فشلٍ جزئيٍّ يستدعي يدًا بشريّةً مهما كان الأثرُ قابلًا للعكس.

### 33.1 الفجوةُ كما قِيسَت — لا كما وُصِفَت

الفجوةُ **لم تُوصَف، بل شُغِّلَت**. اختبارٌ صريحٌ يُنفِّذُ حزمةَ آثارٍ على خزينةٍ
حقيقيّةٍ عبرَ المسارِ الذرّيِّ لـ1H **وحدَه**، ويُفشِلُ الأثرَ الثالث:

| الحقل | القيمة |
|---|---|
| الاختبار | `test_without_compensation_the_state_would_stay_broken` |
| قبلَ العمليّة | `A = 1000` · `B = 500` |
| بعدَ الفشلِ الجزئيّ (1H وحدَها) | **`A = 900` · `B = 600`** |
| حالةُ سجلِّ الذرّيّة | `RECOVERY_REQUIRED` — تشخيصٌ بلا علاج |
| بعدَ 1I على المسارِ نفسِه | **`A = 1000` · `B = 500`** — الحالةُ رجعت |

### 33.2 القرارُ الهندسيّ

| القرار | البديلُ المرفوض | لماذا |
|---|---|---|
| **الإعلانُ قبلَ التنفيذ:** خطّةُ التعويضِ تُربَطُ بالعقدِ قبلَ أيِّ أثر | استنباطُ العكسِ عندَ الفشل | الدولةُ لا تدخلُ فعلًا لا تعرفُ كيف تخرجُ منه — وهو نمطُ `bind_contract` نفسُه: المنعُ سابقٌ لا لاحق |
| **حارسٌ يلفُّ `run_effects_once` القائم** | محرّكُ تنفيذٍ ثالث | لا مسارَ موازٍ ولا مصدرَ حقيقةٍ ثانٍ |
| **تحديثُ سجلِّ الذرّيّةِ نفسِه** بعدَ عكسٍ كامل | سجلُّ تعويضٍ يزعمُ الحقيقةَ بجانبِ سجلِّ 1H | مصدرُ حقيقةٍ واحدٌ لحالةِ العمليّة |
| **الترتيبُ العكسيّ (LIFO)** | أيُّ ترتيب | أثرٌ بُنيَ فوقَ سابقِه يُزالُ قبلَه، وإلّا بقيَ معلّقًا على لا شيء |
| **رفضُ `EffectKind.EXTERNAL` عندَ الربط** | ادّعاءُ `rollback` له | نداءٌ خارجيٌّ وقع لا يُسحَب؛ والادّعاءُ كذبٌ معماريّ |
| **مواصلةُ التعويضِ بعدَ معوّضٍ فاشل** | التوقّفُ عندَ أوّلِ فشل | تقليلُ الضررِ واجب، والباقي يُسمّى نافذًا لا يُخفى |
| **7 حالاتٍ صريحة** بلا `UNKNOWN` | حالتانِ (نجح/فشل) | «عُوِّضَ» و«عُوِّضَ جزئيًّا» و«تعذّرَ» و«غيرُ قابلٍ للعكس» أحكامٌ مختلفة |
| **لا `force` ولا `bypass` ولا `override`** | مَعلَمُ تجاوزٍ للطوارئ | كجدارِ 1G وحارسِ 1H |
...
| `CompensationStatus` | `NOT_REQUIRED` · `PENDING` · `IN_PROGRESS` · `COMPENSATED` · `PARTIALLY_COMPENSATED` · `COMPENSATION_FAILED` · `IRREVERSIBLE` |
| `Compensator` · `CompensationPlan` · `bind_compensation_plan()` | إعلانُ المعكوسِ وربطُه بالعقدِ وإغلاقُه |
| `CompensationJournal` · `CompensationRecord` | سجلٌّ على القرصِ بكتابةٍ ذرّيّة (`os.replace` + `fsync`)، خطواتٌ إضافيّةٌ فقط |
| `CompensationGuard.compensate()` | العكسُ بترتيبٍ عكسيٍّ مع تسجيلٍ **قبلَ** كلِّ معوّضٍ وبعدَه |
| `CompensationGuard.run_compensated_transaction()` | تنفيذٌ ذرّيٌّ (1H) + عكسٌ تلقائيٌّ عندَ الفشل + رفعُ `CompensationRequired` |
| `CompensationGuard.outstanding_debt()` | دَينُ الدولةِ المُعلَن |
| `compute_compensation_id()` | هويّةٌ من المضمون بمجالٍ مستقلّ `AMOS-FEDERATION/COMPENSATION/v1` |
| `tests/sovereignty/test_compensation.py` | **1099 سطرًا · 49 اختبارًا** في 8 تصنيفات |
| `core/sovereignty/__init__.py` | +18 اسمًا في `_EXPORTS` بالنمطِ المتأخّرِ (PEP 562) نفسِه |

**ولم يُعدَّل أيُّ ملفٍّ من الطبقاتِ السابقة:** `contract.py` · `enforcement.py` ·
`jurisdiction.py` · `idempotency.py` · `gateway.py` — ومُثبَتٌ آليًّا
(`test_prior_layers_untouched`).

### 33.4 القدراتُ المُثبَتة — مقيسةً على حالةِ خزينةٍ فعليّة

القياسُ على `_Treasury` حقيقيّةٍ تُلتقَطُ قبلَ العمليّةِ وتُقارَنُ بعدَها — لا
`mock` ولا فحصُ وجودِ اسم.

| القدرة | الدليل |
|---|---|
| **الحالةُ ترجعُ بالضبطِ إلى ما قبلَ العمليّة** | `test_partial_failure_restores_exact_prior_state` |
...
| نجاحٌ = لا سجلَّ تعويضٍ أصلًا | `test_success_leaves_effects_applied_and_opens_no_compensation` |
| أثرٌ مُغيِّرٌ بلا معوّضٍ يُرفَضُ **قبلَ التنفيذ** | `test_mutating_effect_without_compensator_rejected_at_bind` |
| `EXTERNAL` لا تُربَطُ له خطّة | `test_external_effect_contract_cannot_be_compensated` |
| معوّضٌ خارجَ العقدِ أو خارجَ هدفِه مرفوض | `test_compensator_for_undeclared_effect_rejected` · `test_compensator_outside_contract_target_rejected` |
| **فشلُ معوّضٍ ⇒ `PARTIALLY_COMPENSATED` والباقي مُسمًّى** | `test_failing_compensator_yields_partial_and_names_residual` |
| فشلُ معوّضٍ لا يُوقِفُ الباقي | `test_one_failure_does_not_abort_the_rest` |
| أثرٌ مُطبَّقٌ بلا معوّضٍ ⇒ `IRREVERSIBLE` بلا عكسٍ جزئيّ | `test_applied_effect_without_compensator_is_irreversible` |
| `state_is_clean` عقدٌ سلوكيٌّ لا زخرفة | `test_status_flags_are_not_cosmetic` |
| **التعويضُ ذرّيٌّ بذاتِه** — تسلسليًّا وتحتَ 4 خيوطٍ متزامنة | `test_repeated_compensate_does_not_double_reverse` · `test_concurrent_compensation_reverses_once` |
| السجلُّ يبقى بعدَ إعادةِ التشغيل | `test_journal_survives_restart` |
| **الإعلانُ يسبقُ الفعل** — الخطوةُ تُقرَأُ من القرصِ داخلَ المعوّضِ نفسِه | `test_step_written_before_compensator_runs` |
| **عكسٌ كاملٌ يرفعُ `RECOVERY_REQUIRED` وتُعادُ العمليّةُ كاملةً مرّةً واحدة** | `test_clean_compensation_clears_recovery_required` · `test_retry_after_clean_compensation_reapplies_everything` |
...
| اتّجاهُ الاعتمادِ أحاديٌّ محفوظ | `test_compensation_does_not_import_gateway` · `test_compensation_does_not_issue_permits` |

### 33.5 القياسُ — أرقامٌ مقيسة

| البند | القيمة | مقارنةً بـ 1H |
|---|---|---|
| اختباراتُ 1I | **49 ناجحًا** | — |
| `tests/sovereignty/` | **597 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة** | كان 548 |
| `tests/` كاملةً | **1245 ناجحًا · 1 متجاوَزٌ · 3 أخطاء قائمة** | كان 1196 |
...
| `truth_audit --ratchet` | **97 — ثابتٌ بلا زيادة** | ثابت |
| المصالحةُ الدستوريّة | **15** (7 + 8) — مطابقةٌ لقياسِ `b97f0cb` نفسِه | انظر التصحيحَ أدناه |
| `check_repository_identity` | ناجح | ثابت |
| `COMPLETION` | **NOT YET COMPUTABLE** | ثابت |
| التاج | **UNPROVISIONED** | ثابت |

**إثباتُ أنّ الاختباراتِ تقيسُ سلوكًا لا أسماء — Mutation Check.** لأنّ الاختباراتِ
الـ49 نجحت من أوّلِ تشغيل، شُغِّلَت طفرتانِ متعمَّدتان في الكودِ ثمّ أُعيدَ:

| الطفرة | النتيجة |
|---|---|
| `reversed(applied)` → `applied` (قلبُ الترتيب) | **سقطَ اختباران** |
| `compensator.apply()` → `pass` (تعطيلُ العكس) | **سقطَ 12 اختبارًا** |

**تصحيحُ قياسٍ سابق — لا يُترَك.** سجّلَ القسمُ 32 أنّ «المصالحةَ الدستوريّة = 20
— ثابت». والقياسُ الفعليُّ لمخرَجِ الأداةِ على commit `b97f0cb` نفسِه (عبرَ
`git worktree` منفصل) هو **15** (7 تُسَدُّ بالتنفيذ + 8 قراراتٌ بشريّة). فالرقمُ
**لم يتغيّر بفعلِ 1I**، لكنّ الرقمَ المُسجَّلَ سابقًا لم يكن مطابقًا للمخرَج.

### 33.6 ما ليس مُثبَتًا — بصراحة

- **متاحٌ لا مفروض.** كما في 1F و1G و1H: **لا شيءَ يُلزِمُ** أيَّ مسارٍ سياديٍّ
  بربطِ خطّةِ تعويضٍ قبلَ التنفيذ. مَن استدعى `run_effects_once` مباشرةً ما زال
  يستطيع. **الحالة: AVAILABLE / VERIFIED / NOT YET ENFORCED** — والفرضُ يلزمه
  حرسٌ ساكنٌ (1M).
- **لا تعويضَ للأثرِ الخارجيّ** — مرفوضٌ صراحةً لا مُهمَلٌ صمتًا. و**outbox
  مقاومٌ للانهيارِ لم يُبنَ** (دَينٌ مُسجَّلٌ منذ 1H).
- **فشلُ المعوّضِ نفسِه لا يُعوَّض** — لا إعادةَ محاولةٍ ولا backoff؛ تُعلَنُ
  الحالةُ ويُطلَبُ قرارٌ بشريّ.
- **لا استئنافَ تلقائيٍّ لتعويضٍ انقطعَ في منتصفِه.** السجلُّ يحفظُ ما جرى وأيُّ
  معوّضٍ كان قيدَ التنفيذ، لكنّ إعادةَ التشغيلِ لا تُكمِلُه من تلقاءِ نفسِها.
  **NOT PROVEN — لم يُبنَ.**
- **لا توزيعٍ بين العمليّاتِ أو العُقَد** — السجلُّ ملفٌّ محليّ، كسجلِّ 1H.
- **لم تُشاهَد جولةُ CI فعليّة** — كلُّ القياساتِ من بيئةِ الوكيلِ (Python 3.14.3)
  لا من CI (Python 3.12).
- **الأسطرُ الخمسةُ غيرُ المُغطّاة** (`195-197 · 340 · 468`): حذفُ الملفِّ
  المؤقَّتِ عندَ فشلِ الكتابةِ الذرّيّة، وفرعُ إعادةِ فتحِ سجلٍّ غيرِ مُغلَق،
  و`unclean_records` عبرَ مسارٍ غيرِ مباشر. ولم تُطارَد التغطيةُ ولم تُغيَّر عتَبة.

### 33.7 حالاتُ التعويضِ السبع — لا `UNKNOWN`

| الحالة | المعنى | `state_is_clean` | `requires_human` |
|---|---|---|---|
| `NOT_REQUIRED` | لم يُطبَّق أثرٌ يستوجبُ عكسًا | نعم | لا |
| `PENDING` | سجلٌّ فُتِحَ ولم يُبدأ عكسُه | لا | لا |
| `IN_PROGRESS` | العكسُ جارٍ | لا | لا |
| `COMPENSATED` | رجعتِ الحالةُ كاملةً | نعم | لا |
| `PARTIALLY_COMPENSATED` | عُكِسَ بعضٌ وبقيَ أثرٌ نافذٌ مُسمًّى | لا | **نعم** |
| `COMPENSATION_FAILED` | لم يَنجَح أيُّ معوّض | لا | **نعم** |
| `IRREVERSIBLE` | أثرٌ مُطبَّقٌ لا معكوسَ له أصلًا | لا | **نعم** |

### 33.8 ما لا يجوزُ إعادةُ فتحِه

لا تُعَد فتحَ 1I إلّا بتغيّرِ عقدِ 1E أو 1H، أو ببناءِ حرسِ الفرضِ الساكن (1M)، أو
ببناءِ outbox خارجيّ، أو بنمطِ تعويضٍ موزَّع، أو بـregression مقيس، أو بثغرةٍ
أمنيّة، أو بقرارٍ بشريٍّ يُغيّرُ سياسةَ التراجع. ولا تُعَد فتحَ **الحالاتِ السبع**
ولا **قاعدةِ الترتيبِ العكسيّ** ولا **رفضِ `EXTERNAL`** بغيرِ ذلك.

### 33.9 تعارضٌ مقيسٌ في تعريفِ 1I — HUMAN DECISION REQUIRED

المستودعُ يحملُ **تعريفَين متعارضَين** لنطاقِ 1I:

| المصدر | ما يقولُه |
|---|---|
| `PROJECT_STATE.md:22` و`:69` · القسم 32.9 | **1I = Compensation** |
| القسم 29 (تسليمُ 1E) — سطر 2452 | **1I = Fail-Closed** |
| القسم 29 — سطران 2457 و2605 | **1I** تُصلِحُ دلالةَ `ExecutionRecord.executed` |

**ما نُفِّذ:** **Compensation** — التعريفُ المُثبَتُ في `PROJECT_STATE.md` (مصدرُ
الحالةِ الرسميّ) وفي أحدثِ تسليمٍ معتمَد (32.9)، وكلاهما لاحقٌ لتسليمِ 1E.

**ما لم يُنفَّذ ولا يُدَّعى:** (1) **Fail-Closed** — لم يُبنَ. (2) **تصحيحُ دلالةِ
`ExecutionRecord.executed`** — لم يُلمَس؛ الخللُ قائمٌ كما كان منذ ما قبلَ 1E ومعه
اختبارٌ صريحٌ يُثبِتُ الترتيبَ الحاليّ، وتصحيحُه تعديلٌ في `contract.py` ونقضٌ
لإثباتٍ قائمٍ في طبقةٍ معتمَدة.

**لماذا لا يُحسَمُ هندسيًّا:** الحسمُ تقريرُ أيِّ الوثيقتَين هي المرجعُ عندَ
التعارض — قرارُ مرجعيّةٍ لا قرارُ تنفيذ.

**ما يتوقّفُ عليها:** أيُعادُ فتحُ 1I لإضافةِ العملَين، أم يُنقَلانِ رسميًّا إلى 1J؟

### 33.10 الخطوةُ التالية

المرحلةُ التاليةُ في الترتيبِ المُسجَّلِ (القسم 24.9:
`1G · 1H · 1I · 1J · 1K · 1M · 1N`) هي **1J** — و**نطاقُها غيرُ مُثبَتٍ في أيِّ
وثيقة**.

> **HUMAN DECISION REQUIRED — نطاقُ 1J.** الخياراتُ المطروحةُ هندسيًّا:
> (1) **Fail-Closed / Safe-Default**، (2) **Outbox للأثرِ الخارجيّ**،
> (3) **Observability / Sovereign Audit Trail**. وكلُّها قابلةٌ للبناءِ فوقَ 1I،
> ولا نصَّ في المستودعِ يُرجِّحُ واحدًا — واختيارُ الوكيلِ **اختراعُ مرحلة**.

**الأمرُ التالي حرفيًّا:** حسمُ 33.9، وتثبيتُ عنوانِ 1J في `docs/MASTER_PLAN.md`
أو هنا بقرارٍ بشريّ. **ولا تُبدأ 1J قبلَ ذلك.**

التسليمُ الكاملُ المُفصَّل: [`STAGE_1I_HANDOFF.md`](STAGE_1I_HANDOFF.md)

---

---

## 34. STAGE 1J — الإغلاقُ عند الفشل: لا ادّعاءَ نجاحٍ والمعاملةُ ناقصة (2026-08-18)

> **الدعوى المُقاسة:** كان `ExecutionRecord.executed` يُكتَب `True` **قبلَ**
> استدعاءِ المُنفِّذ. فانهيارُ المُنفِّذِ — أو نجاحُه نصفًا — يترك في سجلِّ
> الدولةِ سطرًا يشهد بالنجاح. وسجلُّ البوّابةِ هو مصدرُ الحقيقةِ لما فعلته
> الدولة، و`self_check()` كان يعُدُّ به «التنفيذاتِ السياديّة». فكان الغموضُ
> عيبَ حقيقةٍ لا عيبَ تسمية.

### 34.1 الحسمُ البشريُّ الذي سبقَ التنفيذ

القرار 2 و3 في `PROJECT_STATE.md` (ومرآتُهما §33.9) كانا معلَّقين. حُسِما بقرارٍ
بشريٍّ صريح:

| # | القرار | الحسم |
|---|---|---|
| 1 | نطاقُ 1I | **Compensation** — كما نُفِّذ. **1I مغلقةٌ ولا تُعاد** |
| 2 | Fail-Closed وتصحيحُ دلالةِ `executed` | **مُنقَلانِ رسميًّا إلى 1J** |
| 3 | نطاقُ 1J | **FAIL-CLOSED** — لا Outbox ولا Observability |

**تسليمُ 1I التاريخيُّ لم يُعدَّل** ولا يُدَّعى أنّ الإغلاقَ كان جزءًا منه.

### 34.2 القدرةُ الجديدة — ما صارت الدولةُ تضمنُه

**لا تستطيع الدولةُ أن تدّعي تنفيذًا ناجحًا والمعاملةُ السياديّةُ ناقصة.**

`executed` **لم يعُد حقلًا يُضبَط، بل خصيصةً مقروءةً مُستنبَطةً** من
`ExecutionCompletion`، و`True` منها حالةٌ واحدةٌ فقط: `COMPLETED` — أي تنفيذٌ تامٌّ
مختومٌ بمرتكزٍ تدقيقيٍّ في السجلِّ الدستوريّ. وبناءُ سجلٍّ يزعم النجاحَ زعمًا
مباشرًا صارَ **غيرَ ممكنٍ بنيويًّا**، لا مُستنكَرًا في مراجعة.

| الحالة | `executed` | المعنى |
|---|---|---|
| `NOT_EXECUTED` | `False` | مُنِع أو رُفِض أو أُغلِق قبلَ التنفيذ |
| `AUTHORIZED` | `False` | الإذنُ صدرَ ولم يُختَم شيءٌ بعدَه |
| `COMPLETED` | **`True`** | معاملةٌ تامّةٌ بمرتكزٍ تدقيقيّ |
| `EXECUTION_FAILED` | `False` | انهارَ المُنفِّذ — والاستثناءُ يُعادُ بنوعِه |
| `RECOVERY_REQUIRED` | `False` | عادَ سالمًا بلا إثبات ⇒ لا يُصدَّق (يُحال إلى 1I) |

**مقيسٌ لا موصوف:** انهيارُ مُنفِّذٍ بعدَ أثرٍ جزئيٍّ يترك سطرَ إذنٍ وسطرَ فشلٍ،
و`any(r.executed for r in records) is False`
(`test_انهيارُ_المُنفِّذِ_لا_يترك_ادِّعاءَ_نجاحٍ_واحدًا`).

### 34.3 القرارُ الهندسيّ

| القرار | البديلُ المرفوض | لماذا |
|---|---|---|
| **`executed` خصيصةٌ مُستنبَطةٌ لا حقل** | إبقاءُ الحقلِ وضبطُه في الموضعِ الصحيح | الحقلُ يُبقي الكذبَ ممكنًا: `executed=True` تبقى قابلةً للبناء |
| **سجلّانِ بالإلحاق:** إذنٌ ثمّ سطرٌ مختومٌ بالنتيجة | تعديلُ السجلِّ المكتوب | القاعدة 22: سجلٌّ كُتِبَ لا يُعدَّل ولا يُحذَف — والانهيارُ في المنتصفِ يترك ادّعاءَ إذنٍ لا ادّعاءَ نجاح |
| **نقطةُ فرضٍ وحيدة `_run_and_seal`** | أداةُ إغلاقٍ تُستدعى طوعًا | «لا تكتفِ بإنشاء أداة» — المساران لا يستدعيان المُنفِّذَ إلّا من خلالها، ومُقاسٌ على شجرةِ المصدر |
| **`MandatoryStage` يُعدِّد الموجودَ فقط** | تعدادُ سلسلةِ العقدِ كاملةً (ميزانيّة · سياسة · ذاكرة) | «لا تُضِف فشلًا صناعيًّا لطبقاتٍ لا وجودَ لها» |
| **الاستثناءُ يُعادُ بنوعِه الأصليّ** | لفُّه في `FailClosedError` | المتصلُ يحتاج السببَ لا ترجمتَه؛ والترجمةُ تُخفي التشخيص |
| **القرارُ الملكيُّ بلا مرتكزٍ: يُنفَّذ ولا يُصدَّق** | منعُ التاجِ حتى يُثبَت | حَجرٌ على السيادةِ لا تحسمُه الهندسة — سُجِّل `HUMAN DECISION REQUIRED` |
| **لا اسمَ حالةٍ مُستحدَثٍ بلا حاجة** | حالاتٌ جديدةٌ لكلِّ نوعِ فشل | «لا تخترع أسماءَ حالاتٍ إن كان النموذجُ القائمُ يُعبِّر» |

**قيدٌ دستوريٌّ التُزِم:** `test_المسارُ_السياديُّ_بلا_رفعٍ_دستوريّ` يشترط ألّا
تحوي بنيةُ `_execute_sovereign` عقدةَ `Raise` واحدة — لا يُمنَع التاجُ باستثناءٍ
يُرفَع في وجهِه. فوُضِعَت المحاولةُ وإعادةُ الرفعِ في `_run_and_seal`، وبقيَ
المسارُ السياديُّ بصفرِ عُقَدِ رفع (مُقاسٌ آليًّا).

### 34.4 ما يُفرَض فعلًا

| القاعدة | الدليل |
|---|---|
| حالةٌ إلزاميّةٌ غائبةٌ ⇒ إغلاقٌ قبلَ التنفيذ | `test_فشلُ_الإثباتِ_الإلزاميِّ_يُغلِق_قبل_التنفيذ` |
| منعٌ صريح (دستوريّ · سحبُ صلاحيّة · ادّعاءٌ ملكيٌّ كاذب) | ثلاثةُ اختباراتٍ في `Testالإغلاقُعندالفشل` |
| فشلُ كتابةٍ إلزاميّةٍ في السجلِّ الدستوريّ ⇒ لا تنفيذ | `test_انهيارُ_السجلِّ_الدستوريِّ_يمنع_التنفيذ` |
| معاملةٌ ناقصةٌ ⇒ لا ادّعاءَ تنفيذ | `test_انقطاعُ_العمليّةِ_ليس_نجاحًا` |
| لا استثناءٌ يُبتلَع ولا يُترجَم | `test_الاستثناءُ_يُعادُ_بنوعِه_لا_مُترجَمًا` |
| لا تراجعَ صامتًا ولا قيمةً افتراضيّة | `test_محاولةٌ_فاشلةٌ_لا_تُرجِع_قيمةً_افتراضيّة` |
| أثرٌ جزئيٌّ ≠ نجاح | `test_الأثرُ_الجزئيُّ_لا_يتنكَّر_مكتملًا` |
| لا رايةَ تجاوزٍ ولا إجبار | `test_لا_رايةَ_تجاوزٍ_في_وحدةِ_الإغلاق` |

### 34.5 الملفّات

| الملفّ | الطبيعة |
|---|---|
| `core/sovereignty/fail_closed.py` | **جديد** — 56 عبارة · تغطيةٌ فرعيّة **100%** |
| `core/sovereignty/gateway.py` | مُعدَّل — دلالةُ السجلِّ ونقطةُ الفرض |
| `core/sovereignty/__init__.py` | مُعدَّل — 8 تصديراتٍ مؤجَّلة |
| `tests/sovereignty/test_fail_closed.py` | **جديد** — 37 اختبارًا |
| `tests/sovereignty/test_sovereignty_kernel.py` | مُعدَّل — اختباران صُحِّحا بتعليقٍ يشرح التغيير الدلاليّ |

**لم يُنسَخ التعويضُ ولم يُنقَل:** 1J لا يستورد `compensation.py`؛ يُحيل إليه
بحالةِ `RECOVERY_REQUIRED` فقط.

### 34.6 البوابات المُشغَّلة

| البوابة | النتيجة |
|---|---|
| `tests/sovereignty/test_fail_closed.py` | **37 ناجحًا** |
| `tests/sovereignty/` | **634 ناجح · 1 متجاوَز · 3 أخطاء قائمة** (كانت 597) |
| `tests/` | **1282 ناجح · 1 متجاوَز · 3 أخطاء قائمة** (كانت 1245) |
| تغطيةُ `fail_closed.py` | **100% فرعيّة** |
| `truth_audit --ratchet` | **97 — ثابت** |
| `check_repository_identity` | ناجح |
| `constitutional_reconciliation` | **15 — مطابق** |
| `ruff` على الملفَّين الجديدين | نظيف |
| `ruff` على المستودع | **168 — مطابقٌ للأساس** (لا واحدةَ منها من 1J) |

### 34.7 فحصُ الطفرات — الحراسةُ تُفرَض لا تُوصَف

خمسُ طفراتٍ على المصدرِ ثمّ استعادةُ الأصل، وتشغيلُ 327 اختبارًا بعدَ كلٍّ:

| # | الطفرة | ساقطٌ |
|---|---|---|
| M1 | إعادةُ الثغرةِ التاريخيّة (الاكتمالُ يُكتَب قبلَ المُنفِّذ) | **9** |
| M2 | `AUTHORIZED` يُقرَأ تنفيذًا | **16** |
| M3 | إسقاطُ شرطِ المرتكزِ التدقيقيّ | **1** |
| M4 | ابتلاعُ الاستثناء | **21** |
| M5 | التصديقُ بلا مرتكزٍ تدقيقيّ | **2** |
| — | بعدَ الاستعادة | **327 ناجحًا · صفر ساقط** |

### 34.8 ما لم يُثبَت — حدودُ الصدق

- **لا مراحلَ ميزانيّةٍ ولا سياسةٍ ولا ذاكرةٍ في المعمار.** سلسلةُ العقدِ الكاملةُ
  المذكورةُ في أمرِ 1J تُعدِّد مراحلَ أكثرُها غيرُ موجود؛ لم يُصطنَع لها فشل.
- **الفرضُ محصورٌ في `gateway.execute`.** لا حرسَ ساكنًا يمنع مسارًا مستقبليًّا من
  تجاوزِ `_run_and_seal` — دَينُ 1M.
- **`RECOVERY_REQUIRED` تُعلَن ولا تستدعي تعويضَ 1I آليًّا.**
- **التاجُ `UNPROVISIONED`** — المسارُ السياديُّ مقيسٌ بتاجٍ مؤقّتٍ في الاختبارات.
- **لا جولةَ CI مُشاهَدة** — كلُّ الأرقامِ من بيئةِ الوكيل (Python 3.14.3).

### 34.9 الخطوةُ التالية — HUMAN DECISION REQUIRED

الترتيبُ المُثبَّت في §24.9 يجعل التاليةَ **1K**، و**عنوانُها غيرُ مُثبَتٍ في أيِّ
وثيقةٍ معتمدة**. الدَّينُ المقيسُ المرشَّح: **(أ)** Outbox للأثرِ الخارجيِّ (دَينٌ
مؤكَّدٌ من 1H و1I و1J)؛ **(ب)** وصلُ `RECOVERY_REQUIRED` بتعويضِ 1I واستئنافُ
تعويضٍ انقطع؛ **(ج)** Observability. **لا يُخترَع عنوانٌ لـ1K ولا تُبدأ قبلَ حسمٍ
بشريّ.**

> **تحديثٌ لاحقٌ (2026-08-18) — لا يُعدَّلُ نصُّ 1J أعلاه:** الحسمُ البشريُّ وقعَ
> بعد كتابةِ هذا البند: **1K = Outbox — صادرُ الآثارِ الخارجيّةِ الدائم**
> (`docs/MASTER_PLAN.md § 4` صفٌّ 4). حالتُها الحيّةُ في **§ 35** أدناه.

**التسليم الكامل:** [`STAGE_1J_HANDOFF.md`](STAGE_1J_HANDOFF.md)


---

## 35. STAGE 1K — صادرُ الآثارِ الخارجيّةِ الدائم (Durable External Effects Outbox)

| الحقل | القيمة |
|---|---|
| الحالة | `BUILT / VERIFIED / PUSHED` |
| الأساس | `8f2cdb5` |
| سندُ النطاق | قرارٌ بشريٌّ مؤسَّسيّ — [`MASTER_PLAN § 4`](../MASTER_PLAN.md) صفٌّ 4 |
| الوحدة | `core/sovereignty/outbox.py` |
| الاختبارات | `tests/sovereignty/test_outbox.py` — **89 ناجحًا** |
| التسليم | [`STAGE_1K_HANDOFF.md`](STAGE_1K_HANDOFF.md) |

> **1I = Compensation · 1J = Fail-Closed · 1K = Outbox.** ثلاثةُ نطاقاتٍ مفصولةٌ
> بقرارٍ بشريّ. تسليما 1I و1J التاريخيّانِ **لم يُعدَّلا**.

### 35.1 القدرةُ الجديدة

قبل 1K كان الأثرُ الخارجيُّ **ممنوعًا** في المسارِ الذرّيِّ (1H) و**مرفوضَ
التعويض** (1I): صدقٌ بالامتناع. بعد 1K صارت الدولةُ تُثبِّتُ الأثرَ الخارجيَّ على
القرصِ **قبل** أن تحاولَه، وتنجو محاولتُها من انهيارِ العمليّةِ والعامل، ولا
تشهدُ بالتسليمِ إلّا بتأكيدٍ من المزوّد، ولا تُكذِبُ حين يكونُ المصيرُ مجهولًا.

### 35.2 نموذجُ التماسك — الحدُّ الحقيقيُّ مُعلَنًا

**ديمومةٌ مرتَّبةٌ (ordered durability) لا ذرّيّةٌ عبرَ نظامين.** سجلُّ 1H وسجلُّ
الصادرِ ملفّانِ منفصلان، ولا التزامَ ذرّيًّا يشملُهما. فالاتّجاهُ الخطِرُ مرفوضٌ
بنيويًّا: `enqueue_write_ahead` يرفعُ `OutboxOrderingError` على إدراجٍ **بعد**
تثبيتِ نجاحِ العمليّةِ، وعلى إدراجٍ لعمليّةٍ غيرِ محجوزة. والاتّجاهُ الحميدُ
(سجلُّ صادرٍ بلا عمليّةٍ مكتملة) **مكشوفٌ** بـ`orphaned_effects`. الذرّيّةُ
المُزيَّفةُ لم تُدَّعَ.

### 35.3 نموذجُ التسليم والتفرُّد

- الضمان: **`AT_LEAST_ONCE_WITH_STABLE_IDEMPOTENCY_IDENTITY`**.
- **لا ادّعاءَ exactly-once** — منفيٌّ في الكود:
  `self_check()["claims_exactly_once"] is False`.
- دورةُ الحياة: `PENDING → CLAIMED → {DELIVERED | FAILED_RETRYABLE | DEAD |
  INDETERMINATE}`؛ النهائيُّ `{DELIVERED, DEAD}`.
- هويّةُ الأثرِ `OB-…` حاسمةٌ من (مفتاحِ العمليّة · بصمةِ الأثر · المزوّد · بصمةِ
  الحمولة) — **لا زمنَ ولا عشوائيّة**، ومقيسةٌ بنيويًّا بتحليلِ شجرةِ المصدر.
- إقرارُ المزوّدِ بالتكرار يُقرَأُ **تسليمًا**؛ ومزوّدٌ غيرُ متفرِّدٍ يُصرَّحُ
  بحدِّه (`supports_idempotency is False`).

### 35.4 نوافذُ الانهيارِ A–G

| النافذة | السلوكُ المُثبَت |
|---|---|
| A ثُبِّتَ ولم يُسلَّم | `PENDING` باقٍ ومكتشفٌ بعد إعادةِ التشغيل |
| B حُجِزَ ثمّ انهار | حجزٌ دائمٌ بعقدٍ زمنيّ؛ المهجورُ (بلا طيران) يعودُ `PENDING`، والساري لا يُنتزَع |
| C فشلَ النداء | `FAILED_RETRYABLE` |
| D نجحَ ثمّ انهارَ محلّيًّا | علامةُ طيرانٍ مُثبَّتةٌ قبلَ النداءِ ⇒ `INDETERMINATE` — لا تعليقٌ ولا شهادةٌ ولا إنكار |
| E إعادة | المحاولاتُ تزيدُ مُثبَّتةً ورمزُ التفرُّدِ ثابت |
| F عاملانِ متزامنان | الثاني يُرفَض؛ والأثرُ الخارجيُّ يُقاسُ عدًّا فلا يُضاعَف |
| G نهائيّ | `DEAD` مُثبَّتٌ في صندوقِ الموتى؛ لا انتقالَ بعده |

### 35.5 حدُّ السلطة

الصادرُ **آلةُ تنفيذٍ لا آلةُ سلطة**: يتحقّقُ من `EnforcementPermit` موقَّعٍ
**قائمٍ سابقًا** بمفتاحٍ عامٍّ فقط، ولا يستوردُ محرّكًا ولا بوابةً ولا تاجًا، ولا
رايةَ تجاوزٍ في أيّ دالّةٍ فيه، ولا يقلبُ `DENY` إذنًا، ولا يستهلكُ الإذن
(الاستهلاكُ وظيفةُ 1F). ولا مادّةَ سرّيّةً تُثبَّتُ في حمولةٍ ولا في نصِّ خطأ.
...
| `tests/sovereignty/` | **723 · 1 متجاوَز · 3 أخطاء قائمة** (كانت 634) |
| `tests/` | **1371 · 1 متجاوَز · 3 أخطاء قائمة** (كانت 1282) |
| تغطية `outbox.py` | **96% فرعيّة** — لم تُطارَد |
| فحصُ الطفرات | **6 طفرات ⇒ 25 · 1 · 4 · 2 · 1 · 1** اختبارًا ساقطًا · وبعد الاستعادة 89 ناجحًا |
| `truth_audit --ratchet` | **97 — ثابت**؛ الوحدةُ الجديدةُ لم تُضِف مخالفةً |
| المصالحةُ الدستوريّة | **15** — مطابق |
| `check_repository_identity` | ناجح |
| `ruff` على ملفَّي 1K | نظيف · المستودعُ كلُّه **168** مطابقٌ للأساس (لا يُدَّعى نظافةُ المستودع) |

> **صدقٌ في القياس:** طفرةُ «هويّةِ تفرُّدٍ غيرِ ثابتة» **نجت في الجولةِ الأولى**
> لأنّ القياسَ السلوكيَّ كان يقعُ في الثانيةِ نفسِها. فأُضيفَ اختبارانِ (تحريكُ
> الساعةِ · تحليلُ شجرةِ المصدر) فسقطَت. الثغرةُ كانت في القياسِ وسُجِّلَت.

### 35.7 متاحٌ ولم يُفرَض

- **الصادرُ ليس مسارًا وحيدًا للأثرِ الخارجيّ** — الإلزامُ يحتاجُ حرسَ **1M**.
- **لا مُجدوِلَ يُشغّلُ `OutboxWorker`** — `run_once`/`drain` قائمتانِ بنداءٍ صريح.
- **لا وصلَ** بين `DEAD` وتعويضِ 1I، ولا استعلامَ لدى المزوّدِ لحسمِ
  `INDETERMINATE`، ولا تراجُعَ أُسِّيًّا (backoff).
- **لا توزيعَ** عبرَ عُقَد: قفلٌ داخلَ العمليّةِ وملفٌّ محلّيّ.

### 35.8 HUMAN DECISION REQUIRED

1. حسمُ الأثرِ الغامضِ لدى مزوّدٍ **غيرِ** متفرِّدٍ (استعلامٌ · تسويةٌ يدويّة ·
   قبولُ خطرِ المضاعفة) — لا تحسمُه الهندسة.
2. هل يُلزَمُ كلُّ أثرٍ خارجيٍّ بالمرورِ من الصادر؟ (أثرٌ معماريٌّ واسع — 1M).
3. من يفتحُ صندوقَ الموتى؟ لا وليَّ أمرٍ مؤسَّسيًّا لـ`DEAD`.

### 35.9 التاليةُ بالترتيب

الترتيبُ المُثبَّتُ في §24.9 (`1G · 1H · 1I · 1J · 1K · 1M · 1N`) يجعلُ التاليةَ
**1M — الحرسُ الساكن**، وهي الدَّينُ الذي تُشيرُ إليه 1F و1G و1H و1I و1J وتُضيفُ
إليه 1K بندَها. **نطاقُها التفصيليُّ غيرُ مُثبَتٍ في وثيقةٍ معتمدة** — يُقرَأُ
`MASTER_PLAN` ولا يُخترَع؛ وإلّا فهي **HUMAN DECISION REQUIRED**.

**التسليم الكامل:** [`STAGE_1K_HANDOFF.md`](STAGE_1K_HANDOFF.md)



## 36. STAGE 1M — حدُّ الإنفاذِ السياديُّ والحرسُ الساكن (Enforcement Boundary / Static Guards)

| الحقل | القيمة |
|---|---|
| الحالة | `BUILT / VERIFIED / PUSHED` |
| الأساس | `6562c61` |
| سندُ النطاق | قرارٌ بشريٌّ مؤسَّسيّ — [`MASTER_PLAN § 4`](../MASTER_PLAN.md) صفٌّ 5 |
| الوحدة | `core/sovereignty/enforcement_boundary.py` |
| الاختبارات | `tests/sovereignty/test_enforcement_boundary.py` — **52 ناجحًا** |
| التسليم | [`STAGE_1M_HANDOFF.md`](STAGE_1M_HANDOFF.md) |

> **1M مرحلةُ ربطٍ وإنفاذٍ لا إعادةَ بناء.** 1F و1G و1H و1I و1J و1K **لم تُعدَّلْ
> ولا سطرًا**، ولا ملفَّ منها نُقِل. ما تغيّرَ موضعُ الوصولِ إليها لا مضمونُها.

### 36.1 القدرةُ الجديدة

قبل 1M كان مسارُ التنفيذِ الحقيقيُّ `SovereignGateway.execute(request, executor)`
و`executor` فيه دالّةٌ **مُبهَمة** `Callable[[], T]`: البوّابةُ تفرضُ الهويّةَ
والسلطةَ (1D) والإغلاقَ عندَ الفشلِ (1J) — **وهذا مقيسٌ لا مُفترَض** — ولا تعرفُ
شيئًا عمّا يجري بداخلِها. وقياسُ الأساسِ أظهرَ أنّ `gateway.py` **لا يستوردُ**
الاختصاصَ ولا الذرّيّةَ ولا التعويضَ ولا الصادر، وأنّ `run_effects_once`
و`enqueue_write_ahead` و`.enforce(` و`WALL.evaluate` و`bind_compensation_plan`
و`.deliver(` **بلا موضعِ نداءٍ إنتاجيٍّ واحدٍ** خارجَ وحداتِها واختباراتِها.

بعد 1M صار للدولةِ حدُّ تنفيذٍ **لا يستقبلُ دالّةً مُبهَمة**: المُنادي يُسلِّمُ
خطّةً مُعلَنةً (`declared_effects` · `planner` · `applier` · `operation_key`)،
والحدُّ يُشغّلُ السلسلةَ بالترتيب: الاختصاصُ (1G) ← العقدُ (1E) ← خطّةُ التعويضِ
(1I) ← الهويّةُ والسلطةُ (1D) ← الإغلاقُ عندَ الفشلِ (1J) ← الإذنُ (1F) ←
الذرّيّةُ (1H) ← الصادرُ للأثرِ الخارجيِّ (1K).

### 36.2 نقطةُ الإنفاذ — ولماذا هي لا غيرُها

القرارُ البشريُّ تركَ الاختيارَ للوكيل. قِيسَت ثلاثةُ مواضع:

| الموضع | الحكم |
|---|---|
| إعادةُ تصميمِ كلِّ `executor` | **مرفوض** — عشراتُ الملفّاتِ ولا ضمانَ للمُنفِّذِ القادم |
| إقحامُ الحُرَّاسِ داخلَ `gateway.execute` | **مرفوض** — يجعلُ البوّابةَ مصدرَ حقيقةٍ ثانيًا، ويكسرُ عقودَ كلِّ مُنادٍ قائم |
| **حدُّ المُنفِّذِ المُبهَمِ نفسُه** | **المُختار** — الثغرةُ في **إبهامِ ما تستدعيه** البوّابةُ لا في البوّابة. فأُغلِقَ الإبهام |

الحدُّ **يستدعي** `gateway.decide` ولا يستنسخُ منطقَه، ولا يملكُ مفتاحَ توقيع:
يبني `PolicyEnforcementPoint` من المفتاحِ العامِّ — `signs_permits is False`.
وترتيبُ الرفضِ مقصود: فحصُ تهيئةِ الصادرِ وفحصُ مفتاحِ العمليّةِ **قبلَ**
`decide`، فلا يُصدَرُ إذنٌ موقَّعٌ لطلبٍ ناقص.

### 36.3 الحرسُ الساكن

`StaticEnforcementGuard` يقرأُ AST لـ**18 ملفًّا** في `core/sovereignty` بأربعِ
قواعد: `R1_BYPASS_PARAM` (معاملُ تجاوز) · `R2_DIRECT_PROVIDER_DELIVER` (قفزٌ إلى
مزوّدٍ بلا صادر — إعفاءٌ مُعلَنٌ لـ`outbox.py`) · `R3_UNGUARDED_SUCCESS_CLAIM`
(ادّعاءُ نجاحٍ نهائيٍّ خارجَ وحدةِ الذرّيّة) · `R4_SWALLOWED_GUARD` (ابتلاعُ خطأِ
حرس). و`core/sovereignty` **نظيفٌ منها اليوم** — قياسًا لا دعوى.

**قرارٌ مُعلَنٌ لا إعفاءٌ صامت:** صياغةُ `R3` الأولى أصابت
`compensation.py:789`، وقراءةُ الموضعِ أظهرت أنّه **نقيضُ** التجاوز (تخفيضُ حالةٍ
مشروعٌ بعدَ تعويضٍ ناجحٍ يتلوه `raise`). فبدلًا من إعفاءِ الملفِّ — الذي يُعمي
القاعدةَ عن إساءةٍ مستقبليّةٍ فيه — **ضُيِّقَت القاعدة**. القرارُ مُسجَّلٌ في
وثيقةِ الوحدةِ نفسِها.

### 36.4 القياسات

| المؤشر | القيمة |
|---|---|
| اختبارات 1M | **52 ناجحًا** — تجاوز 24 · تكامل 4 · خصومة 4 · حدودُ دعوى 4 · حرسٌ ساكن 15 · إغلاق 1 |
| `tests/` | **1423 ناجحًا · 1 مُتخطًّى · 3 أخطاءٍ قائمة** — كانت 1371 على `6562c61`؛ الفارق 52 بالضبط |
| فحصُ الطفرات | **8 طفراتٍ ⇒ 8 قتلات** (4 · 1 · 2 · 3 · 1 · 2 · 1 · 2) · ولا طفرةَ نجَت. حملةٌ **موجَّهةٌ** بإذنِ نصِّ القرار |
| `truth_audit --ratchet` | **97 — ثابت**. الصياغةُ الأولى أضافت `SILENT_FALLBACK` واحدةً فرفضتها البوّابة؛ **صُلِحَ المصدرُ ولم يُرفَعِ السقف** |
| `constitutional_reconciliation` | 15 — مطابقة |
| `check_repository_identity` | ناجح |
| `ruff` | نظيفٌ على ملفّي 1M و`__init__.py` · 168 مخالفةً قائمةً في باقي المستودعِ بلا زيادة |
| مسحُ الأسرار | نظيفٌ على الملفّاتِ المتغيّرة |

### 36.5 متاحٌ ولم يُفرَض

1. **الحرسُ الساكنُ في CI** — يعملُ ويُصيب، ولا جولةَ CI مُشاهَدةً في هذا المستودعِ
   قطُّ. فلا يُدَّعى أنّه يمنعُ دمجًا.
2. **المُنادونَ القائمون** — `SubordinateGateway` و`sovereignty_bridge` و`cli.py`
   ما زالت تستدعي `gateway.execute` مباشرةً؛ محروسةٌ بـ1D و1J كما كانت، لا
   باختصاصٍ ولا ذرّيّةٍ ولا صادر. **1M بنَت الحدَّ ولم تُهاجرْ بهم إليه.**
3. **النطاقُ المحروسُ ساكنًا هو `core/sovereignty` وحدَه**، والحرسُ **نصّيٌّ** لا
   يرى نداءً غيرَ مباشرٍ — `detects_indirect_calls is False` في الكود.
4. **لا جدارَ اختصاصٍ فدراليٌّ عامّ** — الجدارُ القائمُ **قضائيٌّ بحصرِه**.

### 36.6 HUMAN DECISION REQUIRED

1. هل يُهاجَرُ المُنادونَ القائمونَ إلى `SovereignExecutionBoundary`؟ (تغييرٌ كاسرٌ
   لعقودِ نداءٍ قائمة — الوكيلُ لا يتّخذُه.)
2. هل يُصبِحُ الحرسُ الساكنُ بوّابةً مانعةً في CI؟ ولمن سلطةُ الإعفاء؟
3. هل يُبنى جدارُ اختصاصٍ فدراليٌّ عامٌّ بجانبِ القضائيّ، وفي أيِّ مرحلة؟

### 36.7 التاليةُ بالترتيب

الترتيبُ المُثبَّتُ في §24.9 (`1G · 1H · 1I · 1J · 1K · 1M · 1N`) يجعلُ التاليةَ
**1N**. **نطاقُها التفصيليُّ غيرُ مُثبَتٍ في وثيقةٍ معتمدة** — يُقرَأُ
`MASTER_PLAN` ولا يُخترَع؛ وإلّا فهي **HUMAN DECISION REQUIRED**.

**التسليم الكامل:** [`STAGE_1M_HANDOFF.md`](STAGE_1M_HANDOFF.md)


---

## 37. STAGE 1N — وصلُ الإنفاذ: الحدُّ صارَ مسارَ التنفيذِ الفعليّ

| البند | القيمة |
|---|---|
| الحالة | BUILT / VERIFIED / PUSHED |
| الأساس | `1cae95f` (تسليم 1M) |
| سندُ النطاق | `docs/MASTER_PLAN.md § 4` الصف 6 — قرارٌ بشريٌّ بتاريخ 2026-08-18 |
| التسليمُ الكامل | [`STAGE_1N_HANDOFF.md`](STAGE_1N_HANDOFF.md) |

### 37.1 السؤالُ الذي أُجيب

1M بنَت `SovereignExecutionBoundary` وأثبتت أنَّ حرسَه لا يُتجاوَز. لكنَّها
تركَت سؤالًا مقيسًا: **مَن يناديه؟** فالتنفيذُ الفدراليُّ الحقيقيُّ كان يمرُّ من
`ConstitutionalAuthorizer.guard` مُمرِّرًا مُنفِّذًا مُبهَمًا لا يُعلِن أثرَه — أي أنَّ
الحدَّ كان قدرةً **قائمةً غيرَ مُنفَذَة**. و1N تُجيبُ هذا السؤالَ وحدَه.

### 37.2 القدرةُ الجديدة

كلُّ انتقالِ حالةٍ في النواةِ التنفيذيّةِ الفدراليّة (إيداعٌ · انتقالٌ · إلغاء) لا
يقعُ إلّا بأثرٍ **مُعلَنٍ قبلَ وقوعِه**، تحتَ إذنٍ مُصدَرٍ لذلك الأثرِ بعينِه،
ومفتاحِ ذرّيّةٍ يمنعُ وقوعَه مرّتين، ومعوّضٍ مربوطٍ بعكسٍ حقيقيّ. وبهذا دخلت 1H
و1I و1M إلى مسارِ الإنتاج — ولم يكن في المستودعِ قبلَ اليومِ مُنشئٌ إنتاجيٌّ
واحدٌ لِـ `IdempotencyLedger`.

### 37.3 ما هُوجِر وما لم يُهاجَر — قياسٌ لا افتراض

| الموضع | الحكم |
|---|---|
| `sovereignty_bridge.ConstitutionalAuthorizer.guard` | **هُوجِر** إلى `guard_declared`؛ والقديمُ يُغلِقُ بِـ `UndeclaredExecutionError` ولا يستدعي المُنفِّذَ أصلًا |
| `engine.submit` و`engine._guarded_transition` | **هُوجِرا**: أثرٌ مُعلَنٌ واحدٌ + مفتاحُ ذرّيّةٍ + معوّضٌ حقيقيّ |
| `gateways.SubordinateGateway.execute` | **هُوجِر** إلى `execute_declared`؛ ولا يُبنى حدٌّ افتراضيٌّ من عندِه |
| `gateway.py` — `execute_contract` و`decide` | **لم تُمَسّ**: `gateway.execute` أوليّةٌ يمرُّ منها الحدُّ نفسُه |
| `cli.py` و`tools/sovereignty/` | **لم تُهاجَر** — أدواتُ إثباتٍ لا تمسُّ حالة. حدٌّ مُعلَنٌ لا مُبرَّرٌ بادّعاء (H-1N-1) |

### 37.4 الدعاوى الستُّ — كلُّها PROVEN سلوكيًّا

المرورُ عبرَ الحدّ (مراحلُ إلزاميّةٌ مقروءةٌ من الحصيلة) · التجاوزُ لا يُنتِجُ
أثرًا (المُنفِّذُ لم يُستدعَ والحالةُ لم تتغيّر) · المُصرَّحُ ينجح (صفٌّ في قاعدةِ
البياناتِ تغيّرَ فعلًا) · غيرُ المُصرَّحِ يُغلَق (بالاستثناءِ نفسِه، وقبلَ صدورِ أيِّ
إذن) · الأثرُ الخارجيُّ لا يبلُغُ المزوّد (مزوّدٌ يُفشِلُ الاختبارَ إن نُودي — لم
يُنادَ) · الانحدارُ سليم. التفصيلُ والأسماءُ في التسليم.

### 37.5 الانحدارُ المقيس

| القياس | الأساس | بعد 1N |
|---|---|---|
| `tests/` (الجذر) | 1423 · 1 مُتخطّاة · 3 أخطاءِ استيرادٍ سابقة | **1440** · 1 · 3 |
| الحزمةُ الفدراليّةُ كاملةً | 1105 نجحت · 19 فشلت · 25 مُتخطّاة | **1115** · 19 · 25 |
| مجموعةُ الفشلِ الفدراليّة | — | **متطابقةٌ حرفًا بحرف** — لا فشلَ أضافته المرحلة |
| `truth_audit --ratchet` | 97 | **97** |
| `constitutional_reconciliation` | 15 | **15** |

الأساسُ الفدراليُّ **قِيسَ ولم يُظَنّ**: خُزِّنت التغييراتُ وأُعيدَ تشغيلُ الحزمةِ
نفسِها على `1cae95f`. و19 الفشلُ كلُّها في سلسلةِ تدقيقِ الأحداث، سابقةٌ للمرحلةِ
ولا تُنسَب إليها ولا تُصلَحُ فيها.

### 37.6 حدودُ الصدق

- الحرسُ الساكنُ لا يمنعُ النداءَ المباشرَ للبوابة؛ المنعُ باختبارِ حرسِ انحدارٍ **مُعلَنِ النطاق** — والحرسُ الأوسعُ **متاحٌ وغيرُ مُنفَذ**.
- ~~لا CI~~ **بَطَلَ**: CI قائمٌ ومُشاهَدٌ (W-003 · W-004)، وحزمةُ التقاطعِ مُنفَذةٌ آليًّا في وظيفةِ `cross-system-suites`. ويبقى أنَّ `main` **أحمرُ** ببوّابتَينِ أمنيّتَينِ (B-9) تنتظرانِ الملك.
- تبعيّاتُ **الجذرِ** صارت مُعلَنةً في `requirements-dev.txt` وحرسٌ يمنعُ عودةَ الأسماءِ العارية (T0.1 · T0.7 · W-017)، وتبعيّاتُ الحزمةِ الفدراليّةِ مُعلَنةٌ في `pyproject` ومُثبَّتةٌ في `requirements.lock`. والتهيئةُ كلُّها بأمرٍ واحد: `bash tools/dev/bootstrap.sh` (T0.2).
- ~~تشغيلُ الانحدارِ يُولِّد `royal/authority/CONSUMED_PERMITS.json`~~ **أُصلِحَ** (O-1N-1 · T0.3 · W-017): مخرَجُ التشغيلِ صارَ خارجَ الشجرةِ عبرَ `AMOS_CONSUMED_PERMITS_PATH` يُوجِّهُه `conftest.py` قبلَ الجمع، فالفحصُ = 0 بلا تنظيفٍ يدويّ. **والمسارُ الافتراضيُّ لم يُنقَلْ** — فـ`H-1N-3` قائمةٌ كما هي، لأنّ نقلَه تعديلٌ لعقدِ مرحلةٍ مُغلَقةٍ وذاكَ قرارٌ بشريّ.

### 37.7 قراراتٌ بشريّةٌ مطلوبة

هجرةُ أدواتِ الإثباتِ أم إعلانُها استثناءً دائمًا (H-1N-1) · إعلانُ التبعيّاتِ
وبوّابةٌ آليّةٌ للانحدارِ الفدراليّ (H-1N-2 — **شقُّها التقنيُّ نُفِّذَ في W-017**، ويبقى إقرارُها سياسةً دائمة) · نقلُ الموضعِ الافتراضيِّ لسجلِّ
الأذونِ المُستهلَكةِ وهو عقدُ مرحلةٍ **مغلقة** (H-1N-3).

### 37.8 التاليةُ بالترتيب

**لا تُخترَع هنا.** تُقرَأُ من `docs/MASTER_PLAN.md § 3` و§ 4 و
`PHASE_E_ROADMAP.md`؛ وإن لم تكن مُثبَّتةً في وثيقةٍ معتمدةٍ فهي
**HUMAN DECISION REQUIRED**.

**التسليم الكامل:** [`STAGE_1N_HANDOFF.md`](STAGE_1N_HANDOFF.md)


## المراجع
- تسليم 1N: [`STAGE_1N_HANDOFF.md`](STAGE_1N_HANDOFF.md)
- تسليم 1M: [`STAGE_1M_HANDOFF.md`](STAGE_1M_HANDOFF.md)
- تسليم 1K: [`STAGE_1K_HANDOFF.md`](STAGE_1K_HANDOFF.md)
- تسليم 1J: [`STAGE_1J_HANDOFF.md`](STAGE_1J_HANDOFF.md)
