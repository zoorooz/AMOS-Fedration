...
- لا CI: الانحدارُ الفدراليُّ مقيسٌ يدويًّا لا مُنفَذٌ آليًّا (القرار #9).
- تبعيّاتُ الحزمةِ الفدراليّةِ غيرُ مُعلَنةٍ في المستودع؛ فالقياسُ غيرُ قابلٍ للتكرارِ بلا تثبيتِها.
- تشغيلُ الانحدارِ يُولِّد `royal/authority/CONSUMED_PERMITS.json` فيُسقِطُ فحصَ الهويّةِ حتى يُمسَح؛ مُنِعَ دفعُه ولم يُمنَع تكوينُه (O-1N-1).

### 37.7 قراراتٌ بشريّةٌ مطلوبة

هجرةُ أدواتِ الإثباتِ أم إعلانُها استثناءً دائمًا (H-1N-1) · إعلانُ التبعيّاتِ
وبوّابةٌ آليّةٌ للانحدارِ الفدراليّ (H-1N-2) · نقلُ الموضعِ الافتراضيِّ لسجلِّ
