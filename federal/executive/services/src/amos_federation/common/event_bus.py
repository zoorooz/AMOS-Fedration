...
EVENT_CONTRACTS = {
    ...
    # ── R9 · الدولة الاقتصادية الوطنية ──────────────────────────────────
    # حمولةٌ **واحدة** لكلّ حدثٍ اقتصاديّ: موضوعٌ وعمليةٌ ونطاقٌ ومؤسسةٌ
    # وتصنيفٌ وفاعل. فمن يقرأ الحدثَ يعرف مَن فعل وبأيّ سلطةٍ وعلى ماذا،
    # ولا يُعلَن حدثٌ اقتصاديٌّ بلا تصنيفِ سلطةٍ حقيقيّ.
    # R9-B — كيانٌ اقتصاديٌّ عامٌّ سُجِّل
    "amos_federation.economy.public_entity_registered": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-K — برنامجٌ اقتصاديٌّ أُنشئ
    "amos_federation.economy.program_created": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-D — سياسةٌ صُدرت (مسوّدةً لا نافذة)
    "amos_federation.economy.policy_created": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-D — سياسةٌ أُنفذت بسلسلةِ إسنادٍ كاملة
    "amos_federation.economy.policy_activated": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-E — مصدرُ إيرادٍ سُجِّل تعريفًا
    "amos_federation.economy.revenue_source_created": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-F — إنفاقٌ أُجيز قبل أيّ حركةِ خزانة
    "amos_federation.economy.expenditure_authorized": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-F — إجازةُ إنفاقٍ نفّذتها الخزانة
    "amos_federation.economy.expenditure_executed": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-I — دعمٌ أُجيز
    "amos_federation.economy.subsidy_authorized": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-G — أصلٌ عامٌّ سُجِّل في هذا النظام
    "amos_federation.economy.public_asset_registered": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-H — التزامٌ عامٌّ سُجِّل
    "amos_federation.economy.public_liability_registered": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-J — مشترياتٌ أُجيزت بتجريدٍ داخليّ
    "amos_federation.economy.procurement_created": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-N — قرارٌ اقتصاديٌّ صُدر بإسنادٍ مُصرَّح
    "amos_federation.economy.decision_issued": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
    ...
    # R9-O — قرارٌ اقتصاديٌّ نُفِّذ بالنواة التنفيذية
    "amos_federation.economy.decision_executed": {
        "required_fields": [
            "subject_id",
            "operation",
            "scope_level",
